 ...
 * @author JE
 */
public class ServicoBaixaOperacionalFiltro extends ServicoBaixaOperacionalEstrategia {
    public String processRequest(HttpServletRequest request,
        ...
        if (servicoBaixa.getTppesport().equalsIgnoreCase("1")){
        	servicoBaixa.setTppesport("F");
        }else{
        	servicoBaixa.setTppesport("J");
        }
