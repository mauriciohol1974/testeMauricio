 ...
 */
public class BG74 implements LayoutTransaction, Serializable {

    public void setLayout(FieldsByTransaction fields) {

        // BG74: Borderô On-line - Excluir Borderô

        fields.listSimpleTransaction.put("BG74-IDA",
                new String[] { "codigoCedente", "codigoBordero", });
        fields.listSimpleTransaction.put("BG74-VOLTA", new String[] {});
    }
}