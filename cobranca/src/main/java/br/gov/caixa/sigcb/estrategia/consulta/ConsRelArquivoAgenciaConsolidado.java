...
public class ConsRelArquivoAgenciaConsolidado extends ConsRelatorioEstrategia {
    ...
    public String processRequest(HttpServletRequest request,
        ...
        String transUser = TRANSACAO_LISTAR_AGENCIA_CONSOLIDADO + usuarioBean.getCodigoUsuario().toUpperCase();
    	...
    	response.setHeader("Content-Disposition","attachment;filename=RelAgenciaConsolidado.csv");
        ...
        cabecalho[1] = "Valor     : " + relFixoBean.getValorLiq()  +"\r\n";
	    cabecalho[2] = "\r\n";;
	    cabecalho[3] = "========================================================================================================================================" + "\r\n";
	    cabecalho[4] = "Data Crédito;Valor Repasse;\r\n";
    ...
    protected void configMsgSucessoErro(HttpServletRequest request) {
        ...
        msgBean.setTitlePage(PAGE_TITLE_LISTAR_UNIDADE_CONSOLIDADO);
