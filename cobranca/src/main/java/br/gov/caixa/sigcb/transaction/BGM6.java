 ...
 */
public class BGM6 implements LayoutTransaction, Serializable {

    public void setLayout(FieldsByTransaction fields) {

        // BGM6: Combo – Porte

        fields.listSimpleTransaction.put("BGM6-IDA", new String[] {});
        fields.listSimpleTransaction.put("BGM6-VOLTA",
