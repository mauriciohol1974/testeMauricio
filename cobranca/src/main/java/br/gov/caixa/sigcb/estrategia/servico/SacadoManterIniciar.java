 ...
 * Componente responsável pelo controle da funcionalidade Sacado >> Manter >>
 * Iniciar.
 * <DL>
 * <DT><B>Criada em:</B>
 * <DD>07/10/2004</DD>
 ...
 */
public class SacadoManterIniciar extends SacadoEstrategia {
    public String processRequest(HttpServletRequest request,
        ...
        if (fluxo.equals(FLUXO_NORMAL)) {
            ...
            sacadoBean.setNavegacao(NAVEGACAO_NORMAL);
        }
