 ...
 */
public class BGA8 implements LayoutTransaction, Serializable {
    ...
    public void setLayout(FieldsByTransaction fields) {
        ...
        fields.listSimpleTransaction.put("BGA8-IDA",
                new String[] { "codigoCedente", "dataLancamento", "tpConsulta", "dtComando"});
        fields.listSimpleTransaction.put("BGA8-VOLTA",
                new String[] {
                              "dataEvento",
                              "nomeServico",
                              "quantidade",
