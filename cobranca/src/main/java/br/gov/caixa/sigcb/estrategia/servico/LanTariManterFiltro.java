...
public class LanTariManterFiltro extends LancamentoTarifaEstrategia {
    ...
    public String processRequest(HttpServletRequest request,
        ...
        try {
            ...
            LancamentoTarifaBean lancamentoTarifa  = (LancamentoTarifaBean) lanTariArrayList.get(0);
            lancamentoTarifaFiltroBean.setValorTotal(lancamentoTarifa.getValorTotal());
