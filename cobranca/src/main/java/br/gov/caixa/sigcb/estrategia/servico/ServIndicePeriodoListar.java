 ...
 */
public class ServIndicePeriodoListar extends IndiceEstrategia {
    public String processRequest(HttpServletRequest request,
      ...
      //  MainFrameTransactionsSigcb handler = SigcbEstrategia.lookUpMFHandler();
        ...
        String transUser = TRANSACAO_LISTAR_PERIODO + usuarioBean.getCodigoUsuario().toUpperCase();
