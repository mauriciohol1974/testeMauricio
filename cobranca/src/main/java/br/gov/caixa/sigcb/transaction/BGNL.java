 ...
 */
public class BGNL implements LayoutTransaction, Serializable {
    ...
    public void setLayout(FieldsByTransaction fields) {
        ...
        fields.listSimpleTransaction.put("BGNL-IDA",
                new String[] { "codigoCedente","tpConsulta", });
        fields.listSimpleTransaction.put("BGNL-VOLTA",
                new String[] {
                              "valorTotal",
                              "dtComando",
                              "coUsuario" });
