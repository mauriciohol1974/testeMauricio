...
public class BaixaOperacionalDetalhe extends BaixaOperacionalEstrategia {
    ...
    public String processRequest(HttpServletRequest request,
        ...
        if (fluxo.equals(FLUXO_NORMAL)) {
        	baixaBean = (BaixaOperacionalBean) baixaBean.getRequestBean(request);
        } else {
        	baixaBean = (BaixaOperacionalBean) baixaBean.getSessionBean(request,   DATA_BEAN);
        }
