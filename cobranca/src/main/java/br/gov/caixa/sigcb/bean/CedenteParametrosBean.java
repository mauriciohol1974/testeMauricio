...
public class CedenteParametrosBean extends SigcbBean {
    ...
    private String codigoContabilDeb;
    ...
    private String icBeneficiario;
    private Long nuSITCS;
    private String autCCA;
    
	private String icIndiceEspecial;
	private String tpIndice;
	private String icAplIndiceEspecial;

	private br.com.politec.sao.util.Money valorLimite;
    ...
    public br.com.politec.sao.util.Money getValorLimite() {
		return valorLimite;
	}

	public void setValorLimite(br.com.politec.sao.util.Money valorLimite) {
		this.valorLimite = valorLimite;
	}

	public String getIcIndiceEspecial() {
		return icIndiceEspecial;
	}

	public void setIcIndiceEspecial(String icIndiceEspecial) {
		this.icIndiceEspecial = icIndiceEspecial;
	}

	public String getTpIndice() {
		return tpIndice;
	}

	public void setTpIndice(String tpIndice) {
	...
	public String getAutCCA() {
		return autCCA;
	}

	public void setAutCCA(String autCCA) {
		this.autCCA = autCCA;
	}

	public String getIcBeneficiario() {
		return icBeneficiario;
	}

	public void setIcBeneficiario(String icBeneficiario) {
		this.icBeneficiario = icBeneficiario;
	}

	public Long getNuSITCS() {
		return nuSITCS;
	}

	public void setNuSITCS(Long nuSITCS) {
		this.nuSITCS = nuSITCS;
	}
	...
	public String getCodigoContabilDeb() {
		return codigoContabilDeb;
	}

	public void setCodigoContabilDeb(String codigoContabilDeb) {
		this.codigoContabilDeb = codigoContabilDeb;
	}
	...
	public boolean equals(Object obj) {
        if (super.equals(obj)) {
            boolean result = true;
            CedenteParametrosBean other = (CedenteParametrosBean) obj;
            ...
            result = result  && equals(getCodigoContabilDeb(), other.getCodigoContabilDeb());
            ...
            result = result  && equals(getIcCEP(), other.getIcCEP());
            result = result  && equals(getIcBeneficiario(), other.getIcBeneficiario());
            result = result  && equals(getNuSITCS(), other.getNuSITCS());
            result = result  && equals(getAutCCA(), other.getAutCCA());
            result = result  && equals(getIcIndiceEspecial(), other.getIcIndiceEspecial());
            result = result  && equals(getTpIndice(), other.getTpIndice());
            result = result  && equals(getIcAplIndiceEspecial(), other.getIcAplIndiceEspecial());
            result = result  && equals(getValorLimite(), other.getValorLimite());
    ...
    private static Layout initLayout() {
        ...
        properties.add(new Property("codigoContabilDeb", StringType.create(),  false, true));
        ...
        properties.add(new Property("icCEP", StringType.create(),  false, true));
        
        properties.add(new Property("nuEvento",  LongType.create(),  false, true));
        
        properties.add(new Property("icBeneficiario", StringType.create(),  false, true));
        
        properties.add(new Property("nuSITCS",  LongType.create(),  false, true));
        
        properties.add(new Property("autCCA", StringType.create(),  false, true));
        
        properties.add(new Property("icIndiceEspecial", StringType.create(),  false, true));
        properties.add(new Property("tpIndice", StringType.create(),  false, true));
        properties.add(new Property("icAplIndiceEspecial", StringType.create(),  false, true));
        
        properties.add(new Property("valorLimite", MoneyType.create(), false, true));
        ...
        Mainframe.put("codigoContabilDeb", new StringValue("X(06)"));
        ...
        Mainframe.put("icCEP", new StringValue("X(01)"));
        Mainframe.put("icBeneficiario", new StringValue("X(02)"));
        Mainframe.put("nuSITCS", new LongValue("9(06)"));
        
        Mainframe.put("autCCA", new StringValue("X(01)"));
        
        Mainframe.put("icIndiceEspecial", new StringValue("X(01)"));
        Mainframe.put("tpIndice", new StringValue("X(15)"));
        Mainframe.put("icAplIndiceEspecial", new StringValue("X(02)"));
        
        Mainframe.put("valorLimite", new MoneyValue("R$ 9(17)v99"));
