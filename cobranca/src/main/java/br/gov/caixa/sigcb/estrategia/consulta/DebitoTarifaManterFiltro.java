...
public class DebitoTarifaManterFiltro extends DebitoTarifaEstrategia {
    ...
    public String processRequest(HttpServletRequest request,
        ...
        try {
            ...
            LancamentoTarifaBean lancamentoFiltro = new LancamentoTarifaBean();
            lancamentoFiltro.setDataFinal(lancamentoTarifaFiltroBean.getDataFinal());
            lancamentoFiltro.setDataInicial(lancamentoTarifaFiltroBean.getDataInicial());
            lancamentoFiltro.setCoUsuario(lancamentoTarifaFiltroBean.getCoUsuario());
            ...
            lancamentoTarifaFiltroBean.setDataInicial(lancamentoFiltro.getDataInicial());
            lancamentoTarifaFiltroBean.setDataFinal(lancamentoFiltro.getDataFinal());
            lancamentoTarifaFiltroBean.setCoUsuario(lancamentoFiltro.getCoUsuario());
