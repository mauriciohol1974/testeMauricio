 ...
 */
public class ReqTituloManterRequisicoes extends ReqRejeitadaEstrategia {
    public String processRequest(HttpServletRequest request,
        ...
        String transUser = TRANSACAO_LISTAR_REQUISICOES + usuarioBean.getCodigoUsuario().toUpperCase();
        ...
        request.setAttribute(FILTRO_BEAN, reqRejBean);
       


        // Nome da JSP a ser chamada (nao possui o .jsp)
        return PAGE_LISTAR_REQUISICOES_TITULO;
    }
    ...
    protected void configMsgSucessoErro(HttpServletRequest request) {
        ...
        msgBean.setTitlePage(PAGE_TITLE_LISTAR_REQUISICOES_TITULO);
