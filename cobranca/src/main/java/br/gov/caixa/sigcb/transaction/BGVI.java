 ...
 */
public class BGVI implements LayoutTransaction, Serializable {

    public void setLayout(FieldsByTransaction fields) {

        // BG48: Banco de Sacados - Excluir/Validar Inclusão

        fields.listSimpleTransaction.put("BGVI-IDA",
                new String[] {
                              "nuSimulacao",
                              "coCanal",
                              "prazoNeg"
                              });
        fields.listSimpleTransaction.put("BGVI-VOLTA", new String[] {});
    }
}