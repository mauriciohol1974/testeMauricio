 ...
 */
public class BcoSacaAlterarFinalizar extends BancoSacadoEstrategia {
    public String processRequest(HttpServletRequest request,
        ...
        bancoSacadoBean.setTipoAcao("A"); // Alterar
        bancoSacadoBean.setMeioEntrada(new Long(1)); // Convencional -
                                                        // Intranet
