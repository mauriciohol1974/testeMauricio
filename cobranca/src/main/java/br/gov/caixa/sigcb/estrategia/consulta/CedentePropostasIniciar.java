...
public class CedentePropostasIniciar extends CedentePropostasEstrategia {
    ...
    public String processRequest(HttpServletRequest request,
        ...
        if (fluxo.equals(FLUXO_NORMAL)) {
        	cedentePropostaBean = (CedentePropostaBean) cedentePropostaBean.newBean();
        } else {
        ...
        request.getSession().setAttribute(CEDENTE_CABECALHO_BEAN, cedentePropostaBean);
        request.getSession().setAttribute(FILTRO_BEAN, cedentePropostaBean);
