...
public class ConsRelGeraArqAgencia extends ConsRelatorioEstrategia {
    ...
    public String processRequest(HttpServletRequest request,
        ...
        String transUser = TRANSACAO_LISTAR_AGENCIA + usuarioBean.getCodigoUsuario().toUpperCase();
    	...
    	response.setHeader("Content-Disposition","attachment;filename=RelArquivoAgencia.csv");
    	...
    	for (int x=0;x<relListaArrayListaBean.size();x++){
    		...
    		linhas[x] = "'"+ relatorioBean.getCedente() +"'" + ";" + relatorioBean.getCpfCpnjFormatado()+ ";"  + relatorioBean.getQtdeLiq() + ";" + relatorioBean.getValorLiq() + ";" + (relatorioBean.getProduto1().toString().equals("S") ? "X" : "") + ";"
    				+ (relatorioBean.getProduto2().toString().equals("S") ? "X" : "") +";" +  (relatorioBean.getProduto3().toString().equals("S") ? "X" : "") + ";" + (relatorioBean.getProduto4().toString().equals("S") ? "X" : "")	;
    	}
    	
    
	    cabecalho[0] = "Consulta Relatório por Agencia >> Lista\r\n";;
	    cabecalho[1] = "========================================================================================================================================" + "\r\n";
	    cabecalho[2] = "Beneficiário;CPF/CNPJ;Quantidade;Valor;SIMPLES;SEM REGISTRO;CAUCIONADA;TERCEIROS;\r\n";
