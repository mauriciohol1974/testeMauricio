 ...
 */
public class ReqTituloManterMotivos extends ReqRejeitadaEstrategia {
    public String processRequest(HttpServletRequest request,
        ...
        return PAGE_LISTAR_MOTIVOS_TITULO;
    }
    ...
    protected void configMsgSucessoErro(HttpServletRequest request) {
        ...
        msgBean.setStrategyErrorReturn(STRATEGY_MANTER_DETALHE_TITULO);
        msgBean.setStrategySucessReturn("");
        msgBean.setTitlePage(PAGE_TITLE_DETALHE_TITULO);
