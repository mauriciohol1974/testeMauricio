 ...
 * @version release 1.0
 */
public class ButtonPaginar extends TagSupport {
    /**
    ...
    public int doStartTag() {
        try {
            ...
            if (this.getPageNumber() > 0)
                buttons.append("<a class='pagina' title='Primeira Página' href=\"javascript:executarPaginacao('0','"
                               + this.getPageName()
                               + "')\">");
            else
            ...
            buttons.append("    <td nowrap>\n");
            if (this.getPageNumber() > 0)
                buttons.append("<a class='pagina' title='Página Anterior' href=\"javascript:executarPaginacao('"
            ...
            for (int i = iniShowPage; i < (endShowPage); i++) {
                ...
                if (this.getPageNumber() != i)
                    buttons.append("<a class='pagina' title='Página "
                                   + (i + 1)
                                   + "' href=\"javascript:executarPaginacao('"
                                   + (i)
                                   + "','"
                                   + this.getPageName()
                                   + "')\">");
            ...
            if (this.getPageNumber() < (this.getNumberOfPages() - 1))
                buttons.append("<a class='pagina' title='Próxima Página' href=\"javascript:executarPaginacao('"
                               + (this.getPageNumber() + 1)
                               + "','"
                               + this.getPageName()
                               + "')\">");
            ...
            buttons.append("    <td nowrap>\n");
            if (this.getPageNumber() < (this.getNumberOfPages() - 1))
                buttons.append("<a class='pagina' title='Última Página' href=\"javascript:executarPaginacao('"
            ...
            getScriptGenerator().addScript("ExecutarPaginacao",
