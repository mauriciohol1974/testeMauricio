 ...
 * @created 12/02/2007 Classe que representa a Guia Geral
 */
public class HistoricoGuiaGeral extends HistoricoGuia {
    ...
    protected LogCedenteGuiasBean montarBean(SigcbBean bean) throws Exception {
        LogUtilSigcb.info("Guia Geral ==> INICIAR HISTORICO DE ALTERACAO");
        LogCedenteGuiasBean logCedenteGuiasBean = (LogCedenteGuiasBean) (new LogCedenteGuiasBean()).newBean();
        logCedenteGuiasBean.setOpcao(GUIA_GERAL);
