 ...
 * @created 12/02/2007 Classe que representa a Guia de Float
 */
public class HistoricoGuiaFloat extends HistoricoGuia {
    ...
    protected LogCedenteGuiasBean montarBean(SigcbBean bean) throws Exception {
        LogUtilSigcb.info("Guia Float ==> INICIAR HISTORICO DE ALTERACAO");
        LogCedenteGuiasBean logCedenteGuiasBean = (LogCedenteGuiasBean) (new LogCedenteGuiasBean()).newBean();
        logCedenteGuiasBean.setOpcao(GUIA_FLOAT);
