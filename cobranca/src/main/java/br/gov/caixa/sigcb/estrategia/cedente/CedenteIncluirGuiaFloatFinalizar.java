 ...
 */
public class CedenteIncluirGuiaFloatFinalizar extends CedenteIncluirEstrategia {
    ...
    public String processRequest(HttpServletRequest request,
        ...
        BeanList blResposta = handler.executeSimpleTransactionQuery(bean,
        		transUser);
