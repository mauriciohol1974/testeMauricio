...
public class DebitoTarifaConsultarDetalheDetIniciar_Incluir extends LancamentoTarifaEstrategia {
    ...
    public String processRequest(HttpServletRequest request,
        ...
        try {
            ...
            request.setAttribute("titulo", "Incluir Comando de Débito de Tarifas >> Listar Tarifas por Data do Evento");

        } catch (Exception e) {
            throw e;
        }
        return PAGE_CONSULTAR_DETALHE_INCLUIR;
    }
