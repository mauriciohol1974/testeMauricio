 ...
 */
public class CedenteImportarTarifasAlterar extends CedenteIncluirEstrategia {
    ...
    public String processRequest(HttpServletRequest request,   HttpServletResponse response) throws Exception {
        ...
        simulacaoBean.setNsuCedente(nsuTransacao);
