 ...
 */
public class CedenteAlterarGuiaContasFinalizar extends CedenteAlterarEstrategia {

    private HistoricoGuia historicoGuiaContas = HistoricoGuiaSimpleFactory.createHistoricoGuiaLogger(HistoricoGuia.GUIA_CONTAS);
    ...
    public String processRequest(HttpServletRequest request,
        ...
        if ("G".equals(contasBean.getTipoAcao())) { // G - atualizar Guia
            ...
            contasBean.setTipoAcao(ALTERACAO);
            contasBean.setCodigoUsuario(this.getCodigoUsuario(request));
            ...
            if (blResposta.size() > 0) {
                ...
                // );
                // this.historicoGuiaContas.logDadosGuia(geralBean, handler,
                ...
                listaGuiasAlteradas.add(this.historicoGuiaContas);
            }
