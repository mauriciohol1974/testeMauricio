 ...
 */
public class BGSS implements LayoutTransaction, Serializable {
    public void setLayout(FieldsByTransaction fields) {

        
    	fields.listSimpleTransaction.put("BGSS-IDA", new String[] {"sigla","dataInicio","dataFim"});

        fields.listSimpleTransaction.put("BGSS-VOLTA",
                new String[] {
                              "sigla",
                              "dataIndice",
                              "valor"});
