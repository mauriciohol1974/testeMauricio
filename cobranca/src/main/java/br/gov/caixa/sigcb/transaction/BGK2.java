 ...
 */
public class BGK2 implements LayoutTransaction, Serializable {

    public void setLayout(FieldsByTransaction fields) {

        // BGK2: Agrupamento Serviços – Excluir / Validar Inclusão Agrupamento
        // Serviços

        fields.listSimpleTransaction.put("BGK2-IDA",
                new String[] { "tipoAcao", "codigoAgrupamento" });
    }
}
