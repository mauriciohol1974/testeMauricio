...
public class ConGerTitulosLiquidadosBean extends SigcbBean {
    ...
    public ConGerTitulosLiquidadosBean() {
    ...
    public String getApplicationName() {
        return "ConGerTitulosLiquidadosBean";
    }
    ...
    public boolean equals(Object obj) {
        if (super.equals(obj)) {
            boolean result = true;
            ConGerTitulosLiquidadosBean other = (ConGerTitulosLiquidadosBean) obj;
            result = result
    ...
    private static Layout initLayout() {
        ...
        properties.add(new Property("valorAbatimento",
                ...
                false,
                true));
        properties.add(new Property("retidoValor",
                MoneyType.create(),
                false,
                true));
        ...
        properties.add(new Property("feriadoLocal", StringType.create(), false, true));
        properties.add(new Property("icRateio", StringType.create(), false, true));
        Layout result = new Layout(properties,
                "ConGerTitulosLiquidadosBean",
        ...
        Mainframe.put("nossoNumeroLista", new LongValue("9(18)"));   
