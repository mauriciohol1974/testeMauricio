...
public class DdaTituloDiaBean extends SigcbBean {
    ...
    public boolean equals(Object obj) {
        if (super.equals(obj)) {
            boolean result = true;
            DdaTituloDiaBean other = (DdaTituloDiaBean) obj;
            result = result
    ...
    private static Layout initLayout() {
        ...
        Mainframe.put("nossoNumero", new LongValue("9(18)"));// 13/09 de
                                                                // 17 p/ 18
