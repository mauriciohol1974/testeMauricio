...
public class ConsRelGeraArqProdutoDetalhe extends ConsRelatorioEstrategia {
    ...
    public String processRequest(HttpServletRequest request,
        ...
        String transUser = TRANSACAO_LISTAR_PRODUTO_DETALHE + usuarioBean.getCodigoUsuario().toUpperCase();
    	...
    	response.setHeader("Content-Disposition","attachment;filename=RelArquivoProdutoDetalhe.csv");
	    ...
	    cabecalho[0] = "Detalhe de Produto por Unidade - "+ relAuditBean.getUnidade().toString() + "\r\n";
	    cabecalho[1] = "========================================================================================================================================" + "\r\n";
	    cabecalho[2] = "Data;Valor Repasse;\r\n";
