 ...
 */
public class ReqTituloManterDetalhe extends ReqRejeitadaEstrategia {
    ...
    protected void configMsgSucessoErro(HttpServletRequest request) {
        ...
        msgBean.setStrategyErrorReturn(STRATEGY_LISTAR_REQUISICOES_TITULO);
