...
public class SacEletronicoExcluirFinalizar extends SacEletronicoEstrategia {
...
//		 Configurações para Mensagens e Telas de Erro e Sucesso
        ...
        handler.executeSimpleTransactionVoid(sacBean,
                TRANSACAO_EXCLUIR_ALTERAR); // Chama a Transacao
...
//	 Configurações para Mensagens e Telas de Erro e Sucesso
    protected void configMsgSucessoErro(HttpServletRequest request) {
        ...
        msgBean.setStrategyErrorReturn(STRATEGY_EXCLUIR_FILTRO);
        msgBean.setStrategySucessReturn(STRATEGY_EXCLUIR_FILTRO);
