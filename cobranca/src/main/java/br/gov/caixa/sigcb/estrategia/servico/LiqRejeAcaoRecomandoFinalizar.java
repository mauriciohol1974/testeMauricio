...
public class LiqRejeAcaoRecomandoFinalizar extends LiqRejeManterEstrategia {
    ...
    public String processRequest(HttpServletRequest request,
        ...
        registroBean.setTipoSolicitacao(new Long(1)); // 1 - Recomando
    ...
    protected void configMsgSucessoErro(HttpServletRequest request) {
        ...
        msgBean.setMsgError("");
        msgBean.setMsgSucess(SUCESSO_RECOMANDO);
