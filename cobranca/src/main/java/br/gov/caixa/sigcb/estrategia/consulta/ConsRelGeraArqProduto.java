...
public class ConsRelGeraArqProduto extends ConsRelatorioEstrategia {
    ...
    public String processRequest(HttpServletRequest request,
        ...
        String transUser = TRANSACAO_LISTAR_PRODUTO + usuarioBean.getCodigoUsuario().toUpperCase();
    	...
    	response.setHeader("Content-Disposition","attachment;filename=RelArquivoProduto.csv");
    	...
    	for (int x=0;x<relListaArrayListaBean.size();x++){
    		...
    		linhas[x] =  relatorioBean.getUnidade() + ";" +  relatorioBean.getQtdeLiq() + ";" + relatorioBean.getValorLiq() ;
    	}
    	
    
	    cabecalho[0] = "Consulta Relatório por Produto >> Lista\r\n";;
	    cabecalho[1] = "========================================================================================================================================" + "\r\n";
	    cabecalho[2] = "Agência;Quantidade;Valor Total;\r\n";
    ...
    protected void configMsgSucessoErro(HttpServletRequest request) {
        ...
        msgBean.setTitlePage(PAGE_LISTAR_PRODUTO);
