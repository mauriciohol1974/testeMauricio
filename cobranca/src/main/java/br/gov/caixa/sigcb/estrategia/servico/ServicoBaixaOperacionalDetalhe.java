 ...
 * @author JE
 */
public class ServicoBaixaOperacionalDetalhe extends ServicoBaixaOperacionalEstrategia {
    public String processRequest(HttpServletRequest request,
        ...
        if(servicoBaixa.getTppesport().equalsIgnoreCase("F")){
        	servicoBaixa.setTppesport("1");
        }else if (servicoBaixa.getTppesport().equalsIgnoreCase("J")){
        	servicoBaixa.setTppesport("2");	
        }
