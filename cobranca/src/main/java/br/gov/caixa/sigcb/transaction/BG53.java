 ...
 */
public class BG53 implements LayoutTransaction, Serializable {

    public void setLayout(FieldsByTransaction fields) {

        // BG53: Banco de Sacados - Listar
        fields.listSimpleTransaction.put("BG53-IDA",
                new String[] { "codigoCedente", "indicadorSolicitacao", });
        fields.listSimpleTransaction.put("BG53-VOLTA",
