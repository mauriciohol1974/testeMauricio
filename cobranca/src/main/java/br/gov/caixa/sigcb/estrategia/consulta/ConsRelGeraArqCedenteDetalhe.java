...
public class ConsRelGeraArqCedenteDetalhe extends ConsRelatorioEstrategia {
    ...
    public String processRequest(HttpServletRequest request,
    	...
    	response.setHeader("Content-Disposition","attachment;filename=RelBeneficiarioDetalhe.csv");
	    ...
	    cabecalho[0] = "Consulta Relatório por Beneficiário >> Detalhe "+ relAuditBean.getCedente().toString()+ "\r\n";;
	    cabecalho[1] = "Produto :" + (relAuditBean.getProduto().toString().equals("1") ? "SIMPLES" : "") +
				(relAuditBean.getProduto().toString().equals("2") ? "SEM REGISTRO" : "")+
				(relAuditBean.getProduto().toString().equals("3") ? "CAUCIONADA" : "")+
				(relAuditBean.getProduto().toString().equals("4") ? "TERCEIROS" : "") + "\r\n";
	    cabecalho[2] = "========================================================================================================================================" + "\r\n";
	    cabecalho[3] = "Data;Valor;\r\n";
