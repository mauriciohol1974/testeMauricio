 ...
 */
public class BGM4 implements LayoutTransaction, Serializable {

    public void setLayout(FieldsByTransaction fields) {

        // BGM4: Combo – Natureza

        fields.listSimpleTransaction.put("BGM4-IDA", new String[] {});
        fields.listSimpleTransaction.put("BGM4-VOLTA",
