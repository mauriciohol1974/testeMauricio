...
public class BaixaEfetivaManterIniciar extends BaixaEfetivaEstrategia {
    ...
    public String processRequest(HttpServletRequest request,
        ...
        if (fluxo.equals(FLUXO_NORMAL)) {
        	baixaBean = (BaixaEfetivaBean) baixaBean.newBean();
        } else {
        	baixaBean = (BaixaEfetivaBean) baixaBean.getSessionBean(request,  FILTRO_BEAN);
        }
