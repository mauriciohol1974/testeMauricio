...
public abstract class TarifaEstrategia extends SigcbEstrategia {

    public static final String STRATEGY_INCLUIR_FILTRO = "servico.TarifaIncluirIniciar";

    public static final String STRATEGY_INCLUIR = "servico.TarifaIncluirFiltro";

    public static final String STRATEGY_INCLUIR_FINALIZAR = "servico.TarifaIncluirFinalizar";
    ...
    public static final String STRATEGY_CONSULTAR = "servico.TarifaConsultarIniciar";

    public static final String PAGE_TITLE_INCLUIR_FILTRO = "Incluir Lançamento de Tarifas Comandadas >> Filtro";

    public static final String PAGE_TITLE_INCLUIR = "Incluir Lançamento de Tarifa Comandada";
    ...
    public static final String PAGE_ERRO = "servico/tarifa_erro";
