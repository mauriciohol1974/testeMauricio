 ...
 */
public class BGWW implements LayoutTransaction, Serializable {

    public void setLayout(FieldsByTransaction fields) {

        // BG74: Borderô On-line - Excluir Borderô

        fields.listSimpleTransaction.put("BGWW-IDA",
                new String[] { "codigoCedente", "codigoBordero", });
        fields.listSimpleTransaction.put("BGWW-VOLTA", new String[] {});
    }
}