 ...
 * @version release 1.0
 */
public class ExecutarPaginacao extends Script {
    ...
    public String getScript() {
        ...
        scr.append("function executarPaginacao(valor, pageName){\n");
        scr.append("  document."
                   + formName
                   + "."
                   + fieldName
    ...
    public void setControlName(String controlName) {
        ...
        case 1:
            this.formName = tokenizer.nextToken();
            LogUtilSigcb.warn("ExecutarPaginacao: falta parametro de controle fieldName");
            break;
        case 0:
            LogUtilSigcb.warn("ExecutarPaginacao: faltam parametros de controle formName e fieldName");
        }
    }
}
