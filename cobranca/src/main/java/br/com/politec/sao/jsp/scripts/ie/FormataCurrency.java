 ...
 * de formatação de moeda de um número.
 * 
...
public class FormataCurrency extends Script {
     ...
     * máscara de formatação de moeda de um número.
     * 
     * @see br.com.politec.sao.jsp.scripts.Script#getScript()
     * @return String - Script das funções formataCurrency e unFormataCurrency.
     */
     ...
     * @return String - Chamada da função formataCurrency.
     */
     ...
     * @return String - Chamada da função unFormataCurrency.
     */
