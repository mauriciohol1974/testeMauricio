 ...
 * formato CEP, impedindo a digitação de caracteres especiais.
 * 
 * @author Glauber M. Gallego - ggallego@sao.politec.com.br
 * @version release 1.0
 */
public class InputCep extends InputTypeText {
    /**
     * Construtor default.
     */
    public InputCep() {
     ...
     * ValidaDigitacaoNumericoInteiro e FormataCep.
     * 
    ...
    public int doStartTag() {
        try {
            ...
            super.getScriptGenerator().addScript("FormataCep", this.getPath());
        } catch (Exception exc) {
            LogUtilSigcb.error("InputCep: Erro na contrucao da Tag: "
                               + exc.getMessage(), exc);
            throw new Error("Erro na contrucao da Tag InputCep.");
        }
     ...
     * formatação do cep quando o controle perder o foco.
     * 
     * @see br.com.politec.sao.jsp.Control#getOnBlur()
     * @return String - Chamada do script FormataCep.
     */
    public String getOnBlur() {
        return super.getScriptGenerator().getOnBlur("FormataCep",
                this.getPath())
               + ";"
               + super.getOnBlur();
    }
     ...
     * retirada da máscara de formatação do Cep quando o controle ganhar o foco.
     * 
     * @see br.com.politec.sao.jsp.Control#getOnFocus()
     * @return String - Chamada do script FormataCep.
     */
    public String getOnFocus() {
        return super.getScriptGenerator().getOnFocus("FormataCep",
                this.getPath())
               + ";"
               + super.getOnFocus();
    }
