...
<p:Document>
	<s:FormStrategy name="frmMain" action="SigcbControle" 
		...
		<s:Menu/>
		<s:Titulo name="Liquidações via STR >> Consultar"/>
		...
		<input type="hidden" name="acaoExecutar" value="<%=filtroBean.getOpcao()  %>">
          ...
          <table width="95%" border="0" cellspacing="1" cellpadding="0" height=53 valign="middle" align="center">
            ...
            <tr>
              <td align="right" colspan="4">
                <p align="center">
                	<s:Button name="recomando" value="Executar ação" action="javascript:formSubmit_recomando();" userGroup="<%=usuarioBean.getNomeGrupo()%>" internalAction="servico.liquidacoes.acoes" />
