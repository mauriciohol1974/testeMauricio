...
<p:Document>
	<s:FormStrategy name="frmMain" action="SigcbControle" 
		estrategia="<%=LancamentoTarifaEstrategia.STRATEGY_CONSULTAR_DETALHE_MANTER%>" fluxo="normal">
		<s:Menu/>
    ...
    <table width="777" BORDER="0" cellspacing="0" cellpadding="0">
      <tr> 
									...
									<tr>
										<td colspan="7" align="center">
											<s:ButtonPaginar 
											  		...
											  		pageName="<%=LancamentoTarifaEstrategia.PAGE_CONSULTAR_DETALHE%>"/>
										</td>
									</tr>
 	                <tr> 
	                  <td colspan="6">&nbsp;</td>
	    ...
	    function formSubmit_Voltar() {
		   document.frmMain.estrategia.value = '<%=LancamentoTarifaEstrategia.STRATEGY_CONSULTAR_MANTER%>';    	
