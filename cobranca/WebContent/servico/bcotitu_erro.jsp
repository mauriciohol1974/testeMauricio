...
<p:Document>
	<s:FormStrategy name="frmMain" action="SigcbControle"
		...
		<input type="hidden" name = "princiDescricaoSituacao" value="<%=tituloBean.getPrinciDescricaoSituacao()%>">
        ...
        <td valign="top" width="95%" height="14" align="left"> 
          <table width="95%" border="0" cellspacing="0" cellpadding="0" height=53 valign="middle" align="center">
            <tr>
              ...
              <td class="textoValor" width="26%"><%=tituloBean.getCodigoCedente().equals( new Long(0))?"":tituloBean.getCodigoCedenteFormatado()%></td>
            ...
            <tr>
              ...
              <td class="textoValor" width="26%"><%=tituloBean.getNossoNumero().equals( new Long(0))?"":tituloBean.getNossoNumeroFormatado()%></td> 
            </tr>
            <tr>
