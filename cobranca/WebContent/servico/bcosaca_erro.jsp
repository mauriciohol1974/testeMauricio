...
*Projeto CAIXA - SIGCB
*Componente: bcosaca_erro.jsp - Java Server Pages
...
<%
	...
	if (session.getAttribute(BancoSacadoEstrategia.MSG_BEAN)==null) {
		msgBean = new MsgSucessoErroBean();
		msgBean.setStrategyErrorReturn(msgBean.getStrategyErrorReturn());
	} else {
		msgBean = (MsgSucessoErroBean) session.getAttribute(BancoSacadoEstrategia.MSG_BEAN);
	}
...
<p:Document>
	<s:FormStrategy name="frmMain" action="SigcbControle"
		...
		<input type="hidden" name="registro" value="<%=bancoSacadoBean.getRegistro()%>">
        ...
        <td valign="top" width="95%" height="14" align="left"> 
          <table width="95%" border="0" cellspacing="0" cellpadding="0" height=53 valign="middle" align="center">
            <tr>
              ...
              <td class="textoValor" width="26%"><%=bancoSacadoBean.getCodigoCedente().equals( new Long(0))?"":bancoSacadoBean.getCodigoCedenteFormatado()%></td>
