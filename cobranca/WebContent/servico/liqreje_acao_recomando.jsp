...
<p:Document>
	<s:FormStrategy name="frmMain" action="SigcbControle" 
		estrategia="servico.LiqRejeAcaoRecomandoFinalizar" fluxo="normal">
		<s:Menu/>
		<s:Titulo name="Liquidações Rejeitadas >> Recomando"/>

		<input type="hidden" name="registro" value="<%= dataBean.getRegistro() %>">
		<input type="hidden" name="radioAcao" value="<%=LiqRejeManterEstrategia.ACAO_RECOMANDO%>">
...
%>
            ...
            <tr>
              ...
              <td class="textoValor" width="26%">
              	<p:InputCurrency CLASS="inputtext" name="valorCorrigido" size="30" maxlength="15" value="<%= valorCorrigido %>" disabled="true"
                	onFocus="javascript: prevFocus(this);"
