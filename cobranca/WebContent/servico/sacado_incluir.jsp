...
<p:Document>
	<s:FormStrategy name="frmMain" action="SigcbControle"
		estrategia="<%=SacadoEstrategia.STRATEGY_INCLUIR_FINALIZAR%>" fluxo="normal">
		<s:Menu/>
		<s:Titulo name="<%=SacadoEstrategia.PAGE_TITLE_INCLUIR%>"/>
      ...
      <tr>
        <td valign="top" width="95%" height="14" align="left">
          <table width="95%" border="0" cellspacing="0" cellpadding="0" height=53 valign="middle" align="center">
            ...
            <tr valign="top">
              <td colspan="5" class="textoTitulo">Incluir Sacado:
                <hr>
              </td>
            </tr>
              ...
              <td colspan="4">
                  <table width="95%" border="0" cellspacing="0" cellpadding="0" height=14 valign="middle" align="center">
                    ...
                    <tr>
                      ...
                      <td class="textoValor" width="26%">
                        <s:ComboUf name="ufSacado" selectedValue='<%=sacadoBean.getUfSacado()%>' branco="true"
                    ...
                    <tr>
                     ...
                     <tr>
                      ...
                      <td class="textoValor" width="26%"><s:ComboMoeda name="moedaCombo" selectedValue='<%=sacadoBean.getMoeda().equals(new Long(0))?"9":sacadoBean.getMoeda().toString()%>' disabled="true"/>
					  </td>
                     ...
                     <tr>
                      ...
                      <td class="textoValor" width="26%">
			                       <p:InputAlfanumerico name="dddSMS" maxlength="2" size="3"   
				                	CLASS="inputtext"
				                	onFocus="javascript: prevFocus(this);"	value ="<%=sacadoBean.getDddSMS().toString() %>" onKeyUp="javascript: nextFocus(event.keyCode, this, document.frmMain.celularSMS);"/>
				                
									<p:InputAlfanumerico name="celularSMS" maxlength="9" size="12"   
				                	CLASS="inputtext"
				                	onFocus="javascript: prevFocus(this);"	value ="<%=sacadoBean.getCelularSMS().toString() %>" onKeyUp="javascript: nextFocus(event.keyCode, this, document.frmMain.tipoSMS);"/>
                      </td>
                      ...
                      <td class="textoValor" width="26%">	
                       <select size="1" name="tipoSMS" disabled="disabled">
							...
							<option value="2">Repr. Numérica</option>
    ...
    <script language="javascript">
	    ...
	    function formSubmit_Voltar() {
    		if (confirm(conf("103"))) {
           document.frmMain.estrategia.value = "<%=SacadoEstrategia.STRATEGY_INCLUIR_INICIAR%>";
