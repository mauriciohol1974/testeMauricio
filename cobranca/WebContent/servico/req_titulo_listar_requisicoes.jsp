...
<p:Document>
	<s:FormStrategy name="frmMain" action="SigcbControle" 
		estrategia="<%=ReqRejeitadaEstrategia.STRATEGY_MANTER_INICIAR_TITULO%>" fluxo="normal">
		<s:Menu/>
		<s:Titulo name="<%=ReqRejeitadaEstrategia.PAGE_TITLE_LISTAR_REQUISICOES_TITULO%>"/>
									...
									<tr>
										<td colspan="5" align="center">
											<s:ButtonPaginar 
											  		...
											  		pageName="<%=ReqRejeitadaEstrategia.PAGE_LISTAR_REQUISICOES_TITULO%>"/>
										</td>
									</tr>
 	                <tr> 
	                  <td colspan="5">&nbsp;</td>
	                ...
	                <tr>
	                  <td align="right" colspan="5">
	                    <p align="center"> 
	                    	...
	                    	<s:Button name="Consultar" action="javascript: formSubmit_detalhe();"/>
	                    </p>
	                  </td>
	                </tr>
 	                <tr> 
    ...
    <script>
	    ...
	    function formSubmit_Voltar() {
	        document.frmMain.estrategia.value = "<%=ReqRejeitadaEstrategia.STRATEGY_MANTER_INICIAR_TITULO%>";
	        document.frmMain.fluxo.value = "voltar";
	        document.frmMain.submit();
      	}
	    
	    function formSubmit_detalhe() {
	    	document.frmMain.fluxo.value = "normal";
	        document.frmMain.estrategia.value = "<%=ReqRejeitadaEstrategia.STRATEGY_MANTER_DETALHE_TITULO%>";
	        document.frmMain.submit();
      	}
