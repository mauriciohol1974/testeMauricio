...
*Projeto CAIXA - SIGCB
*Componente: titulo_incluir.jsp - Java Server Pages
...
<p:Document>
	<s:FormStrategy name="frmMain" action="SigcbControle" 
		estrategia='<%=TituloEstrategia.STRATEGY_INCLUIR_EFETIVAR%>' fluxo="normal">
		<s:Menu/>
		<s:Titulo name="<%=TituloEstrategia.PAGE_TITLE_INCLUIR%>"/>
		...
		<input type="hidden" name = "emissao" value="<%=borderoInfoBean.getEmissaoBloqueto()%>">
		<input type="hidden" name = "sp" value="<%=borderoBean.getSomenteProtesto()%>">
        ...
        <td valign="top" width="95%" height="14" align="left"> 
          <table width="95%" border="0" cellspacing="0" cellpadding="0" height=53 valign="middle" align="center">
            ...
            <tr>
              ...
              <td class="textoValor" width="26%"><%=borderoInfoBean.getTotalTitulos()%></td>
              <td class="textoTitulo" width="17%">Título Atual:</td>
              <td class="textoValor" width="26%"><%=(borderoInfoBean.getTitulosIncluidos().intValue())+1%></td>
            </tr>
            <tr>
              <td colspan="4">&nbsp;</td>
            </tr>
            <tr valign="top"> 
              <td colspan="5" class="textoTitulo">Incluir Título:
                <hr>
              </td>
            </tr>
              ...
              <td colspan="4">
                  <table width="95%" border="0" cellspacing="0" cellpadding="0" height=14 valign="middle" align="center">
				              ...
				              <td class="textoValor" width="26%" nowrap> 
				                <p:InputAlfanumerico name="numeroDocumento" maxlength="11" size="20" 
				                	...
				                	onFocus="javascript: prevFocus(this);"
													onKeyUp='<%=borderoInfoBean.getEmissaoBloqueto().equals(new Long(1))?"javascript: nextFocus(event.keyCode, this, document.frmMain.nossoNumero);":"javascript: nextFocus(event.keyCode, this, document.frmMain.dataVencimentoInput);"%>'/>
                      </td>
                      <td class="textoTitulo" width="17%">Nosso Número: </td>
				              <td class="textoValor" width="26%" nowrap> 
				              <% if(borderoInfoBean.getSomenteProtesto().equalsIgnoreCase("N")) {  %>
				               		<p:InputNumerico name="nossoNumero" maxlength="18" size="23"  
				                	value='<%=borderoTituloBean.getNossoNumero().equals(new Long(0))?"":borderoTituloBean.getNossoNumero().toString()%>'  
				                	disabled='<%=borderoInfoBean.getEmissaoBloqueto().equals(new Long(1))?"false":"true"%>'
				                	CLASS="inputtext"
				                	onFocus="javascript: prevFocus(this);"	onKeyUp="javascript: nextFocus(event.keyCode, this, document.frmMain.dataVencimentoInput);"/>
				              <% } else {%>
				              		 <p:InputNumerico name="nossoNumero" maxlength="15" size="23"  
				                	value='<%=borderoTituloBean.getNossoNumero().equals(new Long(0))?"":borderoTituloBean.getNossoNumero().toString()%>'  
				                	disabled='true'
				                	CLASS="inputtext"
				                	onFocus="javascript: prevFocus(this);"	onKeyUp="javascript: nextFocus(event.keyCode, this, document.frmMain.dataVencimentoInput);"/>
                    ...
                    <tr>
                      ...
                      <td class="textoValor" width="26%">
                        <s:ComboUf name="ufSacado" selectedValue='<%=borderoTituloBean.getUfSacado()%>' branco="true" onChange='javascript:validaAlteracaoEndereco()'/>
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td class="textoValor" width="26%">
				                <p:InputAlfanumericoCep name="municipioSacado" maxlength="35" size="30" 
				                	...
				                	onFocus="javascript: prevFocus(this);"
													onKeyUp='<%=borderoInfoBean.getEndosso().equals("S")?"javascript: nextFocus(event.keyCode, this, document.frmMain.nomeSacadorAvalista);":"javascript: nextFocus(event.keyCode, this, document.frmMain.Confirmar);"%>'/>
                      </td>
                      ...
                      <td class="textoValor" width="26%">
				                <p:InputAlfanumerico name="nomeSacadorAvalista" maxlength="40" size="30" 
				                	...
				                	disabled='<%=borderoInfoBean.getEndosso().equals("S")?"false":"true"%>'
				                	onFocus="javascript: prevFocus(this);"
                    ...
                    <tr>
                      ...
                      <td class="textoValor" width="26%">
	                    <%if(borderoInfoBean.getEndosso().equals("S")){%>
	                       <s:ComboTipoPessoa name="tipoPessoaSacador" selectedValue='<%=borderoTituloBean.getTipoPessoaSacador().equals(new Long(0))?"1":borderoTituloBean.getTipoPessoaSacador().toString()%>'
	                       		onChange="javascript:limpaCpfCnpj(cpfCnpjSacadorInput);"
                         />	   
											<%}
												else{%>
	                       <s:ComboTipoPessoa name="tipoPessoaSacador" disabled="true" branco="true" brancoValue="0" selectedValue="0" />	                       
	                       <%}%>
                      </td>
				              ...
				              <td width="26%" nowrap> 
				              	<p:InputCpfCnpj name="cpfCnpjSacadorInput"
				                	...
				                	disabled='<%=borderoInfoBean.getEndosso().equals("S")?"false":"true"%>'
				              		...
				              		onKeyUp="javascript: nextFocus(event.keyCode, this, document.frmMain.retidoValorIOF);"/>
                      </td>
					  </tr>
					  ...
					  <tr>
					  	...
					  	<td>
					  				<p:InputNumerico name="dddSMS" maxlength="2" size="3"   
					  				value = '<%=borderoTituloBean.getDddSMS().toString()%>'
				                	CLASS="inputtext"
				                	onFocus="javascript: prevFocus(this);"	onKeyUp="javascript: nextFocus(event.keyCode, this, document.frmMain.celularSMS);"/>
				                
									<p:InputNumerico name="celularSMS" maxlength="9" size="12"   
									value = '<%=borderoTituloBean.getCelularSMS().toString()%>'
				                	CLASS="inputtext"
                    ...
                    <tr>
                    	<td nowrap class="textoTitulo" width="17%">Autoriza Pagamento Parcial/Divergente: </td>
                      	<td width="26%" nowrap> 
                       		<s:ComboSimNao name="icParcial" selectedValue='<%=borderoTituloBean.getIcParcial().trim().equals("")?"N":borderoTituloBean.getIcParcial()%>' onChange="javascript: icParcialChange();"/>
                      	</td>
                    </tr>
                    ...
                    <tr>
						...
						<td nowrap class="textoTitulo" width="17%"> Qtde. Pagamentos Possíveis: </td>
                      	<td width="26%" nowrap> 
                       		<p:InputNumerico name="qtdePossivel" maxlength="3" size="2"
			                						CLASS="inputtext" 
    ...
    <script language="javascript">
		...
		function validaSubmit() {
	    	...
	    	var camposObrigatorios = new Array(17);
  			<%=borderoInfoBean.getEmissaoBloqueto().equals(new Long(1)) && borderoBean.getSomenteProtesto().equalsIgnoreCase("N")?"camposObrigatorios[0] = new Array( 'nossoNumero', 'Nosso Número' );":""%>
	    	...
	    	camposObrigatorios[4] = new Array( "nomeSacado", "Nome do Sacado" );
  			<%=borderoInfoBean.getEnvioBloqueto().equals(new Long(3))?"camposObrigatorios[5] = new Array( 'emailSacado', 'e-mail do Sacado' );":""%>
	    	...
	    	camposObrigatorios[13] = new Array( "municipioSacado", "Município do Sacado" );
  			<%=borderoInfoBean.getEndosso().equals("S")?"camposObrigatorios[14] = new Array( 'nomeSacadorAvalista', 'Nome Sacador/Avalista' );":""%>
  			<%=borderoInfoBean.getEndosso().equals("S")?"camposObrigatorios[15] = new Array( 'tipoPessoaSacador', 'Tipo Pessoa Sacador' );":""%>
  			<%=borderoInfoBean.getEndosso().equals("S")?"camposObrigatorios[16] = new Array( 'cpfCnpjSacadorInput', 'CPF/CNPJ do Sacador' );":""%>
	    	camposObrigatorios[17] = new Array( "numeroDocumento", "Número Documento" );	
	    	<%=borderoBean.getSomenteProtesto().equalsIgnoreCase("S")?"camposObrigatorios[0] = new Array( 'dataVencimentoInput', 'Data de Vencimento' );":""%>
	    ...
	    function icParcialChange(){
	    	var formulario = document.frmMain;
	    		...
	    		if (formulario.icParcial.value=="S"){
	    			...
	    			formulario.tipoPgto.value="1";
	    			formulario.qtdePossivel.value="1";
	    ...
	    function iniciaCampos(){
	    	var formulario = document.frmMain;
	    	formulario.tipoPgto.value="<%=borderoTituloBean.getTipoPgto() %>";
	    	formulario.qtdePossivel.value="<%=borderoTituloBean.getQtdePossivel().toString() %>";
	    	formulario.valorMaxPgto.value="<%=borderoTituloBean.getValorMaxPgto().toString().equals("R$ 0,00")?"":borderoTituloBean.getValorMaxPgto().toString() %>";
	    	formulario.valorMinPgto.value="<%=borderoTituloBean.getValorMinPgto().toString().equals("R$ 0,00")?"":borderoTituloBean.getValorMinPgto().toString() %>";
	    	controlaTpPagamentoInicio();
	    	icParcialChangeInicio();
	    	
	    }
	    
	    function controlaTpPagamentoInicio(){
	    	var formulario = document.frmMain;
	    	...
	    	if (formulario.tipoPgto.value=="1"){
	    	 ...
	    	 function icParcialChangeInicio(){
	 	    	var formulario = document.frmMain;
