...
<p:Document>
	<s:FormStrategy name="frmMain" action="SigcbControle"	estrategia="<%=ReqRejeitadaEstrategia.STRATEGY_LISTAR_REQUISICOES%>" fluxo="normal">
		<s:Menu/>
		<s:Titulo name="<%=ReqRejeitadaEstrategia.PAGE_TITLE_DETALHE%>"/>
            ...
            <tr>
	            <td align="right" colspan="4">
  	            <p align="center">
                 	...
                 	<s:Button name="Listar Requisições" action="javascript: formListar();"/>
                 	<s:Button name="Listar Motivos" action="javascript: formSubmit_Motivos();"/>
                </p>
              </td>
            </tr>
            <tr>
    ...
    <script language="javascript">
			...
			function formVoltar() {
				document.frmMain.estrategia.value="<%=ReqRejeitadaEstrategia.STRATEGY_MANTER_CONSULTAR%>";
