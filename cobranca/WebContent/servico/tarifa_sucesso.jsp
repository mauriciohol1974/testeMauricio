...
*Projeto CAIXA - SIGCB
*Componente: tarifa_sucesso.jsp - Java Server Pages
        ...
        <td valign="top" width="95%" height="14" align="left"> 
          <table width="95%" border="0" cellspacing="0" cellpadding="0" height=53 valign="middle" align="center">
            ...
            <tr>
              ...
              <td class="textoValor" width="26%"><%=filtroBean.getTipoTarifa().equals( new Long(1)) ? "TARIFA MANUAL" : "REINSTALAÇÃO DE APLICATIVO PONTA CLIENTE"  %></td>
            </tr>
            <tr>
              <td colspan="4">&nbsp;</td>
            </tr>
