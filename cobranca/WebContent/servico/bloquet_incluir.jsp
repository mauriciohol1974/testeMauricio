...
*Projeto CAIXA - SIGCB
*Componente: bloquet_incluir.jsp - Java Server Pages
*Autor: JE
...
<p:Document>
  <s:FormStrategy name="frmMain" action="SigcbControle" 
    estrategia="<%=BloquetEstrategia.STRATEGY_INCLUIR_FINALIZAR%>" fluxo="normal">
    <s:Menu/>
    <s:Titulo name="<%=BloquetEstrategia.PAGE_TITLE_INCLUIR%>"/>
              ...
              <td colspan="4">
                  <table width="95%" border="0" cellspacing="0" cellpadding="0" height=14 valign="middle" align="center">
                    ...
                    <tr>
				      ...
				      <td class="textoValor" width="26%" nowrap><%=Formatador.formatarData(new Date())%></td>
                    ...
                    <tr>
                      ...
                      <td class="textoValor" width="26%" nowrap>
						<s:ComboEnvioBloqueto name="envioBloqueto" selectedValue='<%=bloquetoBean.getEnvioBloqueto().equals(new Long(0))? "2": bloquetoBean.getEnvioBloqueto()+""%>' codigo="2" disabled="true" />
                      </td>
                    </tr>
                    ...
                    <tr>
				      ...
				      <td class="textoValor" width="26%" nowrap> 
	                      <p:InputNumerico CLASS="inputtext" name="quantidade" size="6" maxlength="4"
                            onFocus="javascript: prevFocus(this);"
    ...
    <script>
			...
			function formSubmit() {
			  if (validaSubmit()) {
			    if (confirm(conf("100", "Solicitação de Boleto On-line"))) {
      ...
      function formSubmit_Voltar() {
        if (confirm(conf("103"))) {
           document.frmMain.estrategia.value = "<%=BloquetEstrategia.STRATEGY_INCLUIR_INICIAR%>";
