...
<html>
	...
	<s:FormStrategy name="frmMain" action="SigcbControle" 
				estrategia='<%=TituloOnLineEstrategia.STRATEGY_CONFIRMAR%>' fluxo="normal">
	<s:Menu/>
          ...
          <table width="95%" border="0" cellspacing="1" cellpadding="0" height=53 valign="middle" align="center">
			...
			<tr>
				      ...
				      <td class="textoValor" width="26%" nowrap colspan="3"> 
        				      	<p:InputNumerico name="codBarras1" maxlength="10" size="12"  
				                	...
				                	onBlur="javascript:habilitaCamposCedente();" disabled="true"/>
        				       	<p:InputNumerico name="codBarras2" maxlength="11" size="13"  
				                	value='<%=tituloBean.getCodBarras2().equals(new Long(0))?"":tituloBean.getCodBarras2().toString()%>'  
				                	CLASS="inputtext"
				                	disabled="true"
				                	onFocus="javascript: prevFocus(this);"	onKeyUp="javascript: nextFocus(event.keyCode, this, document.frmMain.codBarras3);" disabled="true"/>
        				       	<p:InputNumerico name="codBarras3" maxlength="11" size="13"  
				                	value='<%=tituloBean.getCodBarras3().equals(new Long(0))?"":tituloBean.getCodBarras3().toString()%>'  
				                	CLASS="inputtext"
				                	disabled="true"
				                	onFocus="javascript: prevFocus(this);"	onKeyUp="javascript: nextFocus(event.keyCode, this, document.frmMain.codBarras4);" disabled="true"/>
        				       	<p:InputNumerico name="codBarras4" maxlength="1" size="2"  
				                	value='<%=tituloBean.getCodBarras4().equals(new Long(0))?"":tituloBean.getCodBarras4().toString()%>'  
				                	CLASS="inputtext"
				                	disabled="true"
				                	onFocus="javascript: prevFocus(this);"	onKeyUp="javascript: nextFocus(event.keyCode, this, document.frmMain.codBarras5);" disabled="true"/>
        				       	<p:InputNumerico name="codBarras5" maxlength="14" size="17"  
				                	value='<%=tituloBean.getCodBarras5().equals(new Long(0))?"":tituloBean.getCodBarras5().toString()%>'  
				                	CLASS="inputtext"
				                	disabled="true"
				                	onFocus="javascript: prevFocus(this);"	onKeyUp="javascript: nextFocus(event.keyCode, this, document.frmMain.motivoID);" disabled="true"/>
			...
			<tr>
                   ...
                   <td class="textoValor" width="26%" colspan="2">
                    	<s:ComboMotivo name="motivo" disabled="true" selectedValue='<%=tituloBean.getMotivo().equals(new Long(0))?"1":tituloBean.getMotivo().toString()%>'/>
                   </td>
			</tr>	
    ...
    function inicia(){
		...
		function formSubmit() {
			...
			function limpar() {
				document.frmMain.estrategia.value="servico.TituloOnLineIncluir"
			  	document.frmMain.submit();
  			}  
