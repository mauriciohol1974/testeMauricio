...
<%@page import="br.gov.caixa.sigcb.estrategia.servico.TarifaManterEstrategia"%>
...
<%
	...
	if (session.getAttribute(TarifaManterEstrategia.MSG_BEAN)==null) {
		msgBean = new MsgSucessoErroBean();
		msgBean.setStrategyErrorReturn(msgBean.getStrategyErrorReturn());
	} else {
		msgBean = (MsgSucessoErroBean) session.getAttribute(TarifaManterEstrategia.MSG_BEAN);
	}
...
<%
	TarifaManualBean filtroBean = (session.getAttribute(TarifaManterEstrategia.FILTRO_BEAN)==null?new TarifaManualBean():(TarifaManualBean)session.getAttribute(TarifaManterEstrategia.FILTRO_BEAN));
	CedenteCabecaBean cedCabBean = (session.getAttribute(TarifaManterEstrategia.CEDENTE_CABECALHO_BEAN)==null?new CedenteCabecaBean():(CedenteCabecaBean)session.getAttribute(TarifaManterEstrategia.CEDENTE_CABECALHO_BEAN));
%>
