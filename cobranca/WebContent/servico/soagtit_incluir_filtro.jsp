...
*Projeto CAIXA - SIGCB
*Componente: soagtit_incluir_filtro.jsp - Java Server Pages
*Autor: Eduardo A. Morás - emoras@sao.politec.com.br
*Ultima Atualização: 11/10/2004
************************************************/
%>
...
<p:Document>
	<s:FormStrategy name="frmMain" action="SigcbControle" 
		estrategia="<%=SolicitacaoAgendamentoEstrategia.STRATEGY_INCLUIR_FILTRO%>" fluxo="normal">
		<s:Menu/>
		<s:Titulo name="<%=SolicitacaoAgendamentoEstrategia.PAGE_TITLE_INCLUIR_FILTRO%>"/>    
          ...
          <table width="95%" border="0" cellspacing="0" cellpadding="0" height="53" valign="middle" align="center">
              ...
              <td class="textoTitulo" width="36%">
	              <p:InputNumerico name="codigoBancoSacado" maxlength="3" size="3" 
	                	...
	                	onFocus="javascript: prevFocus(this);"
										onKeyUp="javascript: nextFocus(event.keyCode, this, document.frmMain.indicadorSolicitacao);"/>
              </td>
             </tr>
             <tr>
              <td class="textoTitulo" width="17%">Tipo de Requisição: </td>
              <td class="textoTitulo" width="36%">
              	<s:ComboSolicitacaoAgendamento name="indicadorSolicitacao" selectedValue='<%=solicitacaoBean.getIndicadorSolicitacao().equals(new Long (0))?"6":solicitacaoBean.getIndicadorSolicitacao().toString()%>'/>
              </td>
