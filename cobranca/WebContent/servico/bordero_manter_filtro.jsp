...
*Projeto CAIXA - SIGCB
*Componente: bordero_manter_filtro.jsp - Java Server Pages
*Autor: Eduardo A. Morás - emoras@sao.politec.com.br
*Ultima Atualização: 14/09/2004
************************************************/
%>
...
<p:Document>
	<s:FormStrategy name="frmMain" action="SigcbControle" 
		estrategia='<%=BorderoEstrategia.STRATEGY_MANTER_LISTAR%>' fluxo="normal">
		<s:Menu/>
		<s:Titulo name="Manter Borderô >> Filtro"/>    
          ...
          <table width="95%" border="0" cellspacing="0" cellpadding="0" height="53" valign="middle" align="center">
              ...
              <td width="26%"> 
	              <p:InputNumerico name="codigoCedente" maxlength="7" size="7" 
	                	...
	                	onFocus="javascript: prevFocus(this);"
										onKeyUp="javascript: nextFocus(event.keyCode, this, document.frmMain.codigoBordero);"/>
	            </td>
              <td width="17%">&nbsp;</td>
              <td width="26%">&nbsp;</td>
            </tr>
            ...
            <tr> 
	            <td class="textoTitulo" width="17%">Borderô: </td>
      	        ...
      	        <p:InputNumerico name="codigoBordero" maxlength="7" size="9" 
        	        	CLASS="inputtext" value='<%=borderoBean.getCodigoBordero().equals( new Long(0))?"":borderoBean.getCodigoBordero().toString()%>' 
          	      	onFocus="javascript: prevFocus(this);"
