...
<%}%>
        ...
        <td valign="top" width="95%" height="14" align="left"> 
          <table width="95%" border="0" cellspacing="1" cellpadding="0" height=53 valign="middle" align="center">
            ...
            <tr valign="top"> 
              ...
              <td width="26%">
               	<s:ComboEnvioBloqueto name="envioBloqueto" selectedValue='<%=solicitacaoBean.getEnvioBloqueto().equals(new Long(0))?"-1":solicitacaoBean.getEnvioBloqueto().toString()%>' branco="true"/>
              </td>
						</tr>
									 <tr>
	              ...
	              <table width="100%" border="0" cellspacing="0" cellpadding="0" height=14 valign="middle" align="center">
	            	...
	            	<tr>
						...
						<tr>
									...
									<td class="textoValor">	
									<%if (solicitacaoBean.getIndicadorSolicitacao().equals(new Long(7))) {%>
									<p:InputNumerico name="prazoJuros" maxlength="3" size="3" CLASS="inputtext"
    ...
    <script language="javascript">
	    ...
	    function validaSubmit(){
	    	...
	    	camposObrigatorios[4] = new Array( "formaObtencaoBloquetoCombo", "Forma Obtenção Envio Boleto" );
