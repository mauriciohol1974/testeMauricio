...
<p:Document>
    ...
    <table width="777" border="0" cellspacing="0" cellpadding="0">
          ...
          <table width="95%" border="0" cellspacing="0" cellpadding="0" height="53" valign="middle" align="center">
            ...
            <tr>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" height=14 valign="middle" align="center">
                        ...
                        <tr> 
                            <td class="textoTitulo" width="17%">Número do Cartório: </td>
                            <td class="textoValor" width="26%">
                                <p:InputNumerico CLASS="inputtext"
                                    name="numeroCartorio"
                                    value='<%=tituloBean.getNumeroCartorio().equals(new Long(0))?"":tituloBean.getNumeroCartorio().toString()%>'
                                    size="13" maxlength="8" 
                                    onFocus="javascript: prevFocus(this);"
                                    onKeyUp="javascript: nextFocus(event.keyCode, this, document.frmMain.codigoProtocolo);"/> 
                            </td>
                            <td class="textoTitulo" width="17%">&nbsp;</td>
                        ...
                        <tr> 
                            <td class="textoTitulo" width="17%">Código do Protocolo: </td>
                            <td class="textoValor" width="26%">
                                <p:InputNumerico CLASS="inputtext"
                                    name="codigoProtocolo"
                                    value='<%=tituloBean.getCodigoProtocolo().equals(new Long(0))?"":tituloBean.getCodigoProtocolo().toString()%>'
                                    size="13" maxlength="10" 
                                    onFocus="javascript: prevFocus(this);"
                                    onKeyUp="javascript: nextFocus(event.keyCode, this, document.frmMain.dataProtocolo);"/> 
                            </td>
                            <td class="textoTitulo" width="17%">Data do Protocolo: </td>
                            <td class="textoValor" width="26%">
              	                <p:InputDate name="dataProtocolo" CLASS="inputtext" value="<%=tituloBean.getDataProtocoloFormatada()%>"
             	                onFocus="javascript: prevFocus(this);"
                 	            onKeyUp="javascript: nextFocus(event.keyCode, this, document.frmMain.Editar);"/>
                            </td>
                        </tr>    
                ...
                <p align="center"> 
                  <s:Button name="Confirmar" 
                  	action="javascript:formSubmit();"
                   	...
                   	internalAction="servico.protesto.sustageracaoarquivo.acoes"/>                  	
      ...
      function formSubmit() {
			    ...
			    <%}%>
				  	document.frmMain.estrategia.value = "<%=ProtestEstrategia.STRATEGY_ACAO_SUSTA_GER_ARQUIVO%>";
			...
			function validaSubmit() {
				...
				if (!validaCampoObrigatorio(document.frmMain.numeroCartorio, 'Número do Cartório')) {
				    return false;
				}
                if (!validaValorZero(document.frmMain.numeroCartorio, 'Número do Cartório')) {
						return false;
				}
                if (!validaCampoObrigatorio(document.frmMain.codigoProtocolo, 'Código do Protocolo')) {
				    return false;
				}
                if (!validaValorZero(document.frmMain.codigoProtocolo, 'Código do Protocolo')) {
						return false;
				}
                if (!validaCampoObrigatorio(document.frmMain.dataProtocolo, 'Data do Protocolo')) {
				    return false;
				}
				return true;
			}
      ...
      function formSubmit_Voltar() {
	    	document.frmMain.estrategia.value = "servico.ProtestSustaGeracaoArquivoIniciar";
