...
*Componente: ddagerais_titulosvencidos_listar.jsp - Java Server Pages
...
<p:Document>
	<s:FormStrategy name="frmMain" action="SigcbControle"
		...
		<s:Menu/>
		<s:Titulo name="<%=DdaGeraisEstrategia.PAGE_TITLE_TITULOSVENCIDOS_LISTAR%>"/>
          ...
          <table width="95%" border="0" cellspacing="1" cellpadding="0" height=53 valign="middle" align="center">
            ...
            <tr>
              <td colspan="4">&nbsp;</td>
						...
						<tr>
							<td class="textoValor" colspan="4"><br><b>OBS:</b> Consulta classificada por Data de Vencimento</td>
						</tr>
								...
								<table width="100%" border="0" cellspacing="3" cellpadding="0" align="center" valign="middle">
								  <tr class="headerLista">
								    <td width="5%" align="center">&nbsp;</td>
 								    <td nowrap width="25%" align="left">Nosso Numero CIP</td>
								    <td nowrap width="35%" align="left">Vencimento</td>
 								    <td nowrap width="35%" align="left">Valor</td>
								  </tr>
							<%
							...
							%>
								  <tr <%= ( ((i+1)%2) == 0 ) ? "class='line0'" : "class='line1'" %>>
								    <td width="5%" align="center">
 								    ...
 								    <td nowrap width="25%" align="left"><%=occ.getNumeroIdentificacaoDda()%></td>
 								    <td nowrap width="35%" align="left"><%=occ.getDataVencimentoFormatada()%></td>
 								    <td nowrap width="35%" align="left"><%=occ.getValorTitulo()%></td>
								  </tr>
              <%
                  }
              %>
									...
									<tr>
										<td colspan="4" align="center">
											<s:ButtonPaginar
											  		...
											  		pageName="<%=DdaGeraisEstrategia.PAGE_TITULOSVENCIDOS_LISTAR%>"/>
										</td>
									</tr>
 	                <tr>
	                  <td colspan="4">&nbsp;</td>
