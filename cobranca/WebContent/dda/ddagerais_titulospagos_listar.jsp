...
*Componente: ddagerais_titulospagos_listar.jsp - Java Server Pages
...
<p:Document>
	<s:FormStrategy name="frmMain" action="SigcbControle"
		...
		<s:Menu/>
		<s:Titulo name="<%=DdaGeraisEstrategia.PAGE_TITLE_TITULOSPAGOS_LISTAR%>"/>
									...
									<tr>
										<td colspan="5" align="center">
											<s:ButtonPaginar
											  		...
											  		pageName="<%=DdaGeraisEstrategia.PAGE_TITULOSPAGOS_LISTAR%>"/>
										</td>
									</tr>
 	                <tr>
	                  <td colspan="5">&nbsp;</td>
