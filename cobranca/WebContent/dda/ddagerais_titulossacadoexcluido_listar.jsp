...
*Componente: ddagerais_titulossacadoexcluido_listar.jsp - Java Server Pages
...
<p:Document>
	<s:FormStrategy name="frmMain" action="SigcbControle"
		...
		<s:Menu/>
		<s:Titulo name="<%=DdaGeraisEstrategia.PAGE_TITLE_TITULOSSACADOEXCLUIDO_LISTAR%>"/>
									...
									<tr>
										<td colspan="4" align="center">
											<s:ButtonPaginar
											  		...
											  		pageName="<%=DdaGeraisEstrategia.PAGE_TITULOSSACADOEXCLUIDO_LISTAR%>"/>
										</td>
									</tr>
 	                <tr>
	                  <td colspan="4">&nbsp;</td>
