...
*Componente: ddagerais_aceitealegacao_listar.jsp - Java Server Pages
...
<p:Document>
	<s:FormStrategy name="frmMain" action="SigcbControle"
		...
		<s:Menu/>
		<s:Titulo name="<%=DdaGeraisEstrategia.PAGE_TITLE_ACEITEALEGACAO_LISTAR%>"/>
							...
							<td colspan="4">
								<table width="100%" border="0" cellspacing="3" cellpadding="0" align="center" valign="middle">
								  <tr class="headerLista">
								    ...
								    <td nowrap width="18%" align="left">Aceite</td>
								    <td nowrap width="19%" align="left">Valor</td>
 								    <td nowrap width="18%" align="left">&nbsp;</td>
								    <td nowrap width="19%" align="left">&nbsp;</td>
								  </tr>
							<%
							...
							%>
								  <tr <%= ( ((i+1)%2) == 0 ) ? "class='line0'" : "class='line1'" %>>
								    <td width="5%" align="center">
 								    ...
 								    <td nowrap width="18%" align="left"><%=occ.getAceite()%></td>
 								    <td nowrap width="19%" align="left"><%=occ.getValorAceite()%></td>
 								    <td nowrap width="18%" align="left">&nbsp;</td>
								    <td nowrap width="19%" align="left">&nbsp;</td>
								  </tr>
              <%
									...
									<tr>
										<td colspan="6" align="center">
											<s:ButtonPaginar
											  		...
											  		pageName="<%=DdaGeraisEstrategia.PAGE_ACEITEALEGACAO_LISTAR%>"/>
										</td>
									</tr>
 	                <tr>
	                  <td colspan="6">&nbsp;</td>
