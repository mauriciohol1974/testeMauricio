...
*Componente: sac_eletron_excluir.jsp - Java Server Pages
...
<p:Document>  
    <s:FormStrategy name="frmMain" action="SigcbControle" 
		estrategia="<%=SacEletronicoEstrategia.STRATEGY_EXCLUIR_SUCESSO%>" fluxo="normal">
		<s:Menu/>
		<s:Titulo name="<%=SacEletronicoEstrategia.PAGE_TITLE_EXCLUIR%>"/>
