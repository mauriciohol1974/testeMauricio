...
<p:Document>
	<s:FormStrategy name="frmMain" action="SigcbControle" 
		estrategia="<%=AgrupEstrategia.STRATEGY_ALTERAR_SUCESSO%>" fluxo="normal">
		<s:Menu/>
      ...
      <tr> 
        <td valign="top" width="95%" height="14" align="left"> 
          <table width="95%" border="0" cellspacing="1" cellpadding="0" height=53 valign="middle" align="center">
            ...
            <tr valign="top"> 
              <td colspan="4" class="textoTitulo">Alterar Agrupamento de Serviços:
                <hr>
              </td>
            </tr>
    ...
    <script>
	    ...
	    function formSubmit() {
        if (validaSubmit()) {
	    		if (confirm(conf("101", "Agrupamento de Serviços"))) {
	    ...
	    function formSubmit_Voltar() {
    		if (confirm(conf("103"))) {
           document.frmMain.estrategia.value = "<%=AgrupEstrategia.STRATEGY_MANTER_LISTAR%>";
