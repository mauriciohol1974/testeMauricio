...
*Projeto CAIXA - SIGCB
*Componente: agrup_incluir_filtro.jsp - Java Server Pages
...
<p:Document>
	<s:FormStrategy name="frmMain" action="SigcbControle" 
		estrategia="<%=AgrupEstrategia.STRATEGY_INCLUIR%>" fluxo="normal">
		<s:Menu/>
    ...
    <script>
        ...
        if (validaSubmit()) {
		    ...
		    if(!validaCampoObrigatorio(document.frmMain.codigoAgrupamento, 'Agrupamento')){
				  return false;
		    }
		    return true;
		  }			
