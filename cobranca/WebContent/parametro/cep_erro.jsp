...
<%
	...
	if (session.getAttribute(ConsultaCEPEstrategia.MSG_BEAN)==null) {
		msgBean = new MsgSucessoErroBean();
		msgBean.setStrategyErrorReturn(msgBean.getStrategyErrorReturn());
	} else {
		msgBean = (MsgSucessoErroBean) session.getAttribute(ConsultaCEPEstrategia.MSG_BEAN);
	}
	...
	CepBean pvCobBean = (session.getAttribute(ConsultaCEPEstrategia.DATA_BEAN)==null? new CepBean():(CepBean)session.getAttribute(ConsultaCEPEstrategia.DATA_BEAN));
%>
