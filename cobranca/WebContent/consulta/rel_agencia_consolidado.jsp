...
<p:Document>
	<s:FormStrategy name="frmMain" action="SigcbControle"
		estrategia="<%=ConsRelatorioEstrategia.STRATEGY_INICIAR_AGENCIA%>" fluxo="normal">
		<s:Menu />
		<s:Titulo name="Consulta por Agencia e Data de Movimento Consolidado" />
				...
				<table width="95%" border="0" cellspacing="1" cellpadding="0"
					...
					<tr>
						...
						<td class="textoValor" width="26%"><%=fixoBean.getQtdeLiq()%></td>
              			<td class="textoTitulo" width="17%">Valor de Liquidado</td>
	    ...
	    function arquivo() {
	        ...
	        document.frmMain.estrategia.value = "<%=ConsRelatorioEstrategia.STRATEGY_ARQUIVO_AGENCIA_CONSOLIDADO%>";  			
	       	document.frmMain.submit();
		}
