...
*Projeto CAIXA - SIGCB
*Componente: servrej_manter_listar_pvvinc.jsp - Java Server Pages
...
<s:Header/>
  <p:Document>  	
   	<s:FormStrategy name="frmMain" action="SigcbControle" estrategia="consulta.ServRejManterFiltro" fluxo="normal">   	          				
 		<s:Menu/>   		
 		<s:Titulo name="Consultar Serviços Solicitações Rejeitadas (PV)>> Listar "/>
		...
		<input type="hidden" name="tpConsulta" value="899">
							...
							<td colspan="4">
								<table width="100%" border="0" cellspacing="3" cellpadding="0" align="center" valign="middle">
								  <tr class="headerLista">
								    ...
								    <td width="80%" align="left">&nbsp;&nbsp;Nome Fantasia</td>
									...
									<tr>
										<td colspan="6" align="center">
										  <s:ButtonPaginar 
							  				...
							  				pageName="<%=ServRejEstrategia.PAGE_LISTA_PVVINC%>"/>
										</td>
									</tr>
 	                <tr> 
	                  <td colspan="6">&nbsp;</td>
    ...
    <script>
	    ...
	    function formSubmit_Voltar() {
	    	document.frmMain.estrategia.value= "consulta.ServRejManterIniciar";
