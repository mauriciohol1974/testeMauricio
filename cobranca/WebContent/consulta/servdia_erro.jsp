...
*Projeto CAIXA - SIGCB
*Componente: servdia_erro.jsp - Java Server Pages
...
<%
	...
	if (session.getAttribute(ServDiaEstrategia.BEAN_MSG)==null) {
		msgBean = new MsgSucessoErroBean();
		msgBean.setStrategyErrorReturn(msgBean.getStrategyErrorReturn());
	} else {
		msgBean = (MsgSucessoErroBean) session.getAttribute(ServDiaEstrategia.BEAN_MSG);
	}
	...
	ConGerServicosSolicitadosBean cabeEXBean =(ConGerServicosSolicitadosBean)session.getAttribute(ServDiaEstrategia.BEAN_FILTRO);
