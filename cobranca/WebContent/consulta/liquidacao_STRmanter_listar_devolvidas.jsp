...
<p:Document>
    ...
    <table width="777" BORDER="0" cellspacing="0" cellpadding="0">
        ...
        <td valign="top" width="95%" height="14" align="left"> 
          <table width="95%" border="0" cellspacing="1" cellpadding="0" height=53 valign="middle" align="center">
            <tr>
              <td class="textoTitulo" width="17%">Data da Devolução Inicial: </td>
            ...
            <tr>
              <td class="textoTitulo" width="17%">Data da Devolução Final: </td>
							...
							<td colspan="4">
								<table width="777" border="0" cellspacing="3" cellpadding="0" align="center" valign="middle">
								  <tr class="headerLista">
								    ...
								    <td nowrap width="10%" align="right">Valor Devolvido</td>
								    <td nowrap width="10%" align="right">Erro</td>
								    <td nowrap width="05%" align="left">Dev</td>
								    <td nowrap width="05%" align="left">Situação da Devolução</td>
							...
							%>
								  <tr <%= ( ((i+1)%2) == 0 ) ? "class='line0'" : "class='line1'" %>>
								    <td width="2%" align="center">
								    	<input type="radio" name="radioSTR" onclick="javascript:clickRadio('<%=occ.getBanco()%>','<%=occ.getDataRecebimento()%>','<%=occ.getHoraRecebimento()%>','<%=occ.getSequencial()%>','<%=occ.getCodErro()%>','<%=occ.getCodDevolucao()%>');">
								    </td>
								    ...
								    <td nowrap width="10%" align="right"><%= occ.getValorDevolvido()%></td>
								    <td nowrap align="center"><%= occ.getCodErro() %></td>
								    <td nowrap align="left"><%=occ.getCodDevolucao() %></td>
	                  ...
	                  <td colspan="11">&nbsp;</td>
									...
									<tr>
										<td colspan="11" align="center">
											<%String pageName =ConsultaLiqStrManterEstrategia.PAGE_LISTAR_DEVOLVIDAS;%>
										  <s:paginacao		estrategia="<%=ConsultaLiqStrManterEstrategia.STRATEGY_LISTA_DEVOLVIDAS %>" />
										</td>
									</tr>
    ...
    <script>
			...
			function formSubmit_Consultar() {
					...
					document.frmMain.estrategia.value = "consulta.ConsultaLiqSTRDevolvida";
	    	...
	    	function voltar(){
      		...
      		function clickRadio(banco, data, hora, sequencial, erro, devol) {
      			...
      			document.frmMain.codErro.value = erro;
      			document.frmMain.codDevolucao.value = devol;
