...
<s:Header/>
  <p:Document>  	
   	<s:FormStrategy name="frmMain" action="SigcbControle" estrategia="consulta.DdaTitBaixadoRejManterFiltro" fluxo="normal">   	          				
 		<s:Menu/>   		
 		<s:Titulo name="DDA >> Consultar Títulos Baixados Rejeitados >> Listar"/>
 	                ...
 	                <tr> 
	                  <td colspan="6">&nbsp;</td>
									...
									<tr>
										...
										<% String pageName = DdaTitIncluidoEstrategia.PAGE_DDA_LISTA_PV_B_REJ;%>
										  <s:ButtonPaginar 
