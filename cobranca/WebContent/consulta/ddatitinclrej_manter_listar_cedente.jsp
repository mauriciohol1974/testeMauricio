...
<p:Document>
	<s:FormStrategy name="frmMain" action="SigcbControle"
		estrategia="consulta.DdaTitIncluidoRejConsultar" fluxo="normal">
		<s:Menu />
		<s:Titulo name="DDA >> Consultar Títulos Incluidos Rejeitados" />
			...
			<tr>
				...
				<table width="95%" border="0" cellspacing="1" cellpadding="0"
                    ...
                    %>
							...
							<tr>
								<td colspan="6" align="center"><%String pageName = DdaTitIncluidoEstrategia.PAGE_DDA_LISTA_CED_I_REJ;%>
								<!-- s:ButtonPaginar 
											  		pageNumber="<%=paginacao.getPageNumber()%>" 
											  		numberOfPages="<%=paginacao.getPageCount()%>" 
											  		pageName="<%=pageName%>"/--><s:paginacao
									estrategia="consulta.DdaTitIncluidoRejManterFiltro" /></td>
							</tr>
							<tr>
								<td colspan="5">&nbsp;</td>
							</tr>
        ...
        document.frmMain.estrategia.value = "consulta.DdaTitIncluidoRejManterFiltro";  			
