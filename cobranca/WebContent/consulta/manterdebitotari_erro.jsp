...
*Projeto CAIXA - SIGCB
*Componente: lantari_erro.jsp - Java Server Pages
...
<%
	...
	if (session.getAttribute(DebitoTarifaEstrategia.MSG_BEAN)==null) {
		msgBean = new MsgSucessoErroBean();
		msgBean.setStrategyErrorReturn(msgBean.getStrategyErrorReturn());
	} else {
		msgBean = (MsgSucessoErroBean) session.getAttribute(DebitoTarifaEstrategia.MSG_BEAN);
	}
