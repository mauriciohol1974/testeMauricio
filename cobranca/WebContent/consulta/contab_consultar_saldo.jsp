...
*Projeto CAIXA - SIGCB
*Componente: contab_consultar_saldo.jsp - Java Server Pages
...
<s:Visibility visible="<%=pagina1%>">								
		<s:Titulo name="<%=ContabEstrategia.PAGE_TITLE_SALDO_PV%>"/>    
</s:Visibility>		  	
<s:Visibility visible="<%=pagina2%>">								
		<s:Titulo name="<%=ContabEstrategia.PAGE_TITLE_SALDO_REC%>"/>    
</s:Visibility>		  	
<s:Visibility visible="<%=pagina3%>">								
		<s:Titulo name="<%=ContabEstrategia.PAGE_TITLE_SALDO_CAIXA_REC%>"/>    
</s:Visibility>
<s:Visibility visible="<%=pagina4%>">								
		<s:Titulo name="<%=ContabEstrategia.PAGE_TITLE_SALDO_CAIXA_PV%>"/>    
</s:Visibility>
							...
							<td colspan="4">
								<table width="100%" border="0" cellspacing="3" cellpadding="0" align="center" valign="middle">
								  <tr class="headerLista">
								    ...
								    <td nowrap width="30%" align="center" colspan="2">Interligação</td>
								    <td nowrap width="30%" align="center" colspan="2">Boletos Rejeitados</td>
								  </tr>								  
								  <tr class="headerLista">
								    <td nowrap width="2%" align="center">&nbsp;</td>
<s:Visibility visible="<%=pagina3%>">	
								    <td nowrap width="5%" align="right">RSRET</td>
</s:Visibility>									    
<s:Visibility visible="<%=!pagina3%>">	
								    <td nowrap width="5%" align="right">PV</td>
</s:Visibility>									 								    
								    <td nowrap width="20%" align="left">Nome</td>
								    <td nowrap width="15%" align="right">Tarifas Receber</td>
								    <td nowrap width="15%" align="right">Credito</td>
								    <td nowrap width="15%" align="right">Débito</td>
								    <td nowrap width="15%" align="right">Compensação</td>
								    <td nowrap width="15%" align="right">Outros Meios</td>
								  </tr>
							<%
...
<s:Visibility visible="<%=!pagina3%>">	
								    ...
								    <td nowrap width="5%" align="right"><%=occ.getCodigoUnidadeFormatado()%></td>
								    <td nowrap width="20%" align="left"><%=occ.getNomeUnidade()%></td>
								    <td nowrap width="15%" align="right"><%=occ.getTarifaReceber()%></td>
								    <td nowrap width="15%" align="right"><%=occ.getCredito()%></td>
								    <td nowrap width="15%" align="right"><%=occ.getDebito()%></td>
								    <td nowrap width="15%" align="right"><%=occ.getCompensacao()%></td>								    								    
								    <td nowrap width="15%" align="right"><%=occ.getOutroMeio()%></td>								    								    
								  </tr>
						<%  } %>			
								  <tr <%=(lista.size())%2 == 0 ? "class='line1'" : "class='line0'" %>>
								    <td nowrap width="2%" align="center">&nbsp;</td>
								    <td nowrap class="textoDestaqueValor" width="5%" align="right">Total</td>
								    <td nowrap class="textoDestaqueValor" width="20%" align="right">&nbsp;</td>
								    <td nowrap class="textoDestaqueValor" width="15%" align="right"><%=contabilBean.getTotalTarifaReceber()%></td>
								    <td nowrap class="textoDestaqueValor" width="15%" align="right"><%=contabilBean.getTotalCredito()%></td>
								    <td nowrap class="textoDestaqueValor" width="15%" align="right"><%=contabilBean.getTotalDebito()%></td>
								    <td nowrap class="textoDestaqueValor" width="15%" align="right"><%=contabilBean.getTotalBloquetoRejeitadoCompensacao()%></td>								    
								    <td nowrap class="textoDestaqueValor" width="15%" align="right"><%=contabilBean.getTotalBloquetoRejeitadoOutrosMeios()%></td>
								  </tr>
									...
									<tr>
										<td colspan="8" align="center">
											<s:ButtonPaginar 
											  		...
											  		pageName="<%=ContabEstrategia.PAGE_CONSULTAR_SALDO%>"/>
										</td>
									</tr>
 	                <tr> 
	                  <td colspan="8">&nbsp;</td>
