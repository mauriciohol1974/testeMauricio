...
*Projeto CAIXA - SIGCB
*Componente: girocai_manter_listar_cpfcnpj.jsp - Java Server Pages
...
<p:Document>
	<s:FormStrategy name="frmMain" action="SigcbControle" 
		...
		<s:Menu/>
		<s:Titulo name="<%=GiroCaixaEstrategia.PAGE_TITLE_LISTAR_CPFCNPJ%>"/>    
        ...
        <td valign="top" width="95%" height="14" align="left"> 
          <table width="95%" border="0" cellspacing="1" cellpadding="0" height=53 valign="middle" align="center">
            <tr>
              ...
              <td class="textoValor" width="26%"><%=giroCaixaBean.getTipoPessoaTexto()%></td>

              <td class="textoTitulo" width="17%">CNPJ </td>
              <td nowrap class="textoValor" width="26%"><%=giroCaixaBean.getCpfCnpjFormatado()%></td> 
            </tr>
            <tr> 
              <td colspan="4">&nbsp;</td>
            </tr>
							...
							<td colspan="4">
								<table width="100%" border="0" cellspacing="3" cellpadding="0" align="center" valign="middle">
								  <tr class="headerLista">
								    ...
								    <td nowrap width="88%" align="left">Nome Cedente</td>
								  </tr>
							<%
							...
							%>
									  ...
									  <tr <%= ( ((i+1)%2) == 0 ) ? "class='line0'" : "class='line1'" %>>
									    <td width="2%" align="center">
	 								    ...
	 								    <td width="88%" align="left"><%=occ.getNomeFantasia()%></td>
									  </tr>
						<%  } %>	  
									...
									<tr>
										<td colspan="6" align="center">
											<s:ButtonPaginar 
											  		...
											  		pageName="<%=GiroCaixaEstrategia.PAGE_JSP_LISTAR_CPFCNPJ%>"/>
										</td>
									</tr>
 	                <tr> 
	                  <td colspan="6">&nbsp;</td>
