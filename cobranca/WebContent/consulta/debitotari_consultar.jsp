...
<p:Document>
	<s:FormStrategy name="frmMain" action="SigcbControle" 
		...
		<s:Menu/>
		<s:Titulo name="Consultar Comandos de Débito de Tarifas >> Listar Tarifas por Data do Evento"/>    
      ...
      <tr> 
        <td valign="top" width="95%" height="14" align="left"> 
          <table width="95%" border="0" cellspacing="1" cellpadding="0" height=53 valign="middle" align="center">
            ...
            <tr>
              <td class="textoTitulo" width="17%">Usuáro: </td>
              <td class="textoValor" width="26%"><%=lancamentoTarifaBean.getCoUsuario()%></td> 
              <td class="textoTitulo" width="17%">Situação: </td>
              <td class="textoValor" width="26%"><%=lancamentoTarifaBean.getSituacao()%></td>
            </tr>     
             <tr>

              <td class="textoTitulo" width="17%">Data do Débito: </td>
									...
									<tr>
										<td colspan="7" align="center">
											<s:ButtonPaginar 
											  		...
											  		pageName="<%=DebitoTarifaEstrategia.PAGE_CONSULTAR%>"/>
										</td>
									</tr>
 	                <tr> 
	                  <td colspan="6">&nbsp;</td>
	    ...
	    function formSubmit_Voltar() {
						document.frmMain.estrategia.value = '<%=DebitoTarifaEstrategia.STRATEGY_CONSULTAR%>';    	
