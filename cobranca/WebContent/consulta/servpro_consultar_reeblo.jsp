...
*Projeto CAIXA - SIGCB
*Componente: servpro_consultar_reeblo.jsp - Java Server Pages
*Autor: Valdir Castaldelli Junior - vcastaldelli@sao.politec.com.br
*Ultima Atualização: 09/11/2004 - v1
************************************************/
%>
								...
								<table width="100%" border="0" cellspacing="3" cellpadding="0" align="center" valign="middle">
								  <tr class="headerLista">
								    ...
								    <td nowrap width="20%" align="left">Nome Sacado</td>
 								    <td nowrap width="20%" align="left">Número Documento</td>
							...
							<%  } %>								 
								  <tr>
							  		...
							  		<s:ButtonPaginar 
							  				...
							  				pageName="<%=ServProEstrategia.PAGE_REE_BLO%>"/>
										</td>
									</tr>
								</table>
							</td>
