...
*Projeto CAIXA - SIGCB
*Componente: servpro_consular_blopreimp.jsp - Java Server Pages
...
<%
	ConGerServicosSolicitadosBean cabeEXBean = (ConGerServicosSolicitadosBean)session.getAttribute(ServProEstrategia.BEAN_DATA);
	
	CedenteCabecaBean cedCabBean 			=	(CedenteCabecaBean)session.getAttribute(ServProEstrategia.BEAN_CABECALHO);
								...
								<table width="100%" border="0" cellspacing="3" cellpadding="0" align="center" valign="middle">
								  <tr class="headerLista">
								    ...
								    <td nowrap width="10%" align="right">Qtd. Boletos</td>
 								    ...
 								    <td nowrap width="10%" align="left">Meio de Entrada</td>
                                    				    <td nowrap width="10%" align="left">Nro Pedido Gráfica</td>
								    <td nowrap width="1%" align="center">&nbsp;</td>
								  </tr>
							<%
							...
							%>	  
								  <tr <%= ( ((i+1)%2) == 0 ) ? "class='line0'" : "class='line1'" %>>
								    <td nowrap width="1%"	 align="center">&nbsp;</td>
 								    ...
 								    <td nowrap width="10%" align="right"><%=occ.getCodigoUsuario()%></td>
                                    ...
                                    <td nowrap width="10%" align="right"><%=occ.getNroPedidoGrafica()%></td>
 								    <td nowrap width="1%"	 align="center">&nbsp;</td>
								  </tr>
							<%  } %>								  
								</table>
