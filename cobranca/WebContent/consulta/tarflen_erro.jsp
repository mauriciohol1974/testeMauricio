...
*Projeto CAIXA - SIGCB
*Componente: tarflen_erro.jsp - Java Server Pages
...
<%
	...
	if (session.getAttribute(TarFlEnEstrategia.BEAN_MSG)==null) {
		msgBean = new MsgSucessoErroBean();
		msgBean.setStrategyErrorReturn(msgBean.getStrategyErrorReturn());
	} else {
		msgBean = (MsgSucessoErroBean) session.getAttribute(TarFlEnEstrategia.BEAN_MSG);
	}
	...
	ConGerTarifaFloatENBean filtroBean =(session.getAttribute(TarFlEnEstrategia.BEAN_FILTRO)==null? new ConGerTarifaFloatENBean()
																		:(ConGerTarifaFloatENBean)session.getAttribute(TarFlEnEstrategia.BEAN_FILTRO));
%>
      ...
      <tr> 
        <td valign="top" width="95%" height="14" align="left"> 
          <table width="95%" border="0" cellspacing="0" cellpadding="0" height=53 valign="middle" align="center">						
              ...
              <td class="textoValor" width="26%"><%=filtroBean.getNomeUnidadeEn()%></td>
            </tr>
