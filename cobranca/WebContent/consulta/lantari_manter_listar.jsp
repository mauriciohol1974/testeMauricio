...
<p:Document>
	<s:FormStrategy name="frmMain" action="SigcbControle" 
		estrategia="<%=LancamentoTarifaEstrategia.STRATEGY_CONSULTAR%>" fluxo="normal">
		<s:Menu/>
		<s:Titulo name="<%=LancamentoTarifaEstrategia.PAGE_TITLE_LISTA%>"/>    
    ...
    <table width="777" BORDER="0" cellspacing="0" cellpadding="0">
      <tr> 
									...
									<tr>
										<td colspan="6" align="center">
											<s:ButtonPaginar 
											  		...
											  		pageName="<%=LancamentoTarifaEstrategia.PAGE_LISTAR%>"/>
										</td>
									</tr>
 	                <tr> 
	                  <td colspan="6">&nbsp;</td>
	    ...
	    function formSubmit_Voltar() {
						document.frmMain.estrategia.value = '<%=LancamentoTarifaEstrategia.STRATEGY_MANTER_INICIAR%>';    	
