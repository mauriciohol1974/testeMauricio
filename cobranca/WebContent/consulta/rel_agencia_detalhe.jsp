...
<p:Document>
	<s:FormStrategy name="frmMain" action="SigcbControle"
		...
		<s:Menu />
		<s:Titulo name="Consulta Relatório por Agencia >> Detalhe" />

		<input type="hidden" name="<%=ConsRelatorioEstrategia.PAGINACAO_PAGE%>"	value="">
		
		<input type="hidden" name="unidade"	value="<%=filtroBean.getCedente()%>">
		...
		<table width="777" BORDER="0" cellspacing="0" cellpadding="0">
			<tr>
				...
				<table width="95%" border="0" cellspacing="1" cellpadding="0"
					...
					<tr>
						<td colspan="4"class="textoTitulo" >Beneficiário:<%=filtroBean.getCedente() %></td>
					</tr>
					...
					<tr>
						...
						<table width="100%" border="0" cellspacing="3" cellpadding="0"
							...
							<tr class="headerLista">
								...
								<td nowrap width="25%" align="center">&nbsp;Data Crédito&nbsp;</td>
        ...
        document.frmMain.estrategia.value = "<%=ConsRelatorioEstrategia.STRATEGY_FILTRO_AGENCIA_LISTAR%>";  			
	    ...
	    function arquivo() {
	        ...
	        document.frmMain.estrategia.value = "<%=ConsRelatorioEstrategia.STRATEGY_ARQUIVO_AGENCIA_DETALHE%>";  			
	       	document.frmMain.submit();
		}
