...
*Projeto CAIXA - SIGCB
*Componente: hisced_erro.jsp - Java Server Pages
...
<%
	...
	if (session.getAttribute(BaixaOperacionalEstrategia.MSG_BEAN)==null) {
		msgBean = new MsgSucessoErroBean();
		msgBean.setStrategyErrorReturn(msgBean.getStrategyErrorReturn());
	} else {
		msgBean = (MsgSucessoErroBean) session.getAttribute(BaixaOperacionalEstrategia.MSG_BEAN);
	}
