...
<s:Header/>
  <p:Document>  	
   	<s:FormStrategy name="frmMain" action="SigcbControle" estrategia="consulta.DdaTitAlteradoManterFiltro" fluxo="normal">   	          				
 		<s:Menu/>   		
 		<s:Titulo name="DDA >> Consultar Títulos Alterados >> Listar"/>
 	                ...
 	                <tr> 
	                  <td colspan="6">&nbsp;</td>
									...
									<tr>
										...
										<% String pageName = DdaTitIncluidoEstrategia.PAGE_DDA_LISTA_PV_A;%>
										  <s:ButtonPaginar 
