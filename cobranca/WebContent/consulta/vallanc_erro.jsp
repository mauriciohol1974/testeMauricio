...
*Projeto CAIXA - SIGCB
*Componente: vallanc_erro.jsp - Java Server Pages
*Autor: Valdir Castaldelli Junior - vcastaldelli@sao.politec.com.br
*Ultima Atualização: 04/10/2004
************************************************/
%>
...
<%
	...
	if (session.getAttribute(ValLancManterEstrategia.MSG_BEAN)==null) {
		msgBean = new MsgSucessoErroBean();
		msgBean.setStrategyErrorReturn(msgBean.getStrategyErrorReturn());
	} else {
		msgBean = (MsgSucessoErroBean) session.getAttribute(ValLancManterEstrategia.MSG_BEAN);
	}
        ...
        <td valign="top" width="95%" height="14" align="left"> 
          <table width="95%" border="0" cellspacing="0" cellpadding="0" height=53 valign="middle" align="center">						
            ...
            <tr>
              ...
              <td class="textoValor" width="26%"><%=valLancBean.getConta().equals(new Long(0))? "":valLancBean.getContaFormatado()%></td>
	          </tr>
            <tr>
              <td class="textoTitulo" width="17%">Unidade: </td>
		          <td class="textoValor" width="26%"><%=valLancBean.getUnidadeVinculacao().equals(new Long(0))? "":valLancBean.getUnidadeVinculacaoFormatado()%></td>
              <td class="textoTitulo" width="17%">operacao: </td>
              <td class="textoValor" width="26%"><%=valLancBean.getOperacao().equals(new Long(0))? "":valLancBean.getOperacaoFormatado()%></td>
            </tr>
