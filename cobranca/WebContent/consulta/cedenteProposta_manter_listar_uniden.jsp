...
<%
 	UnidadePVConteudoListaBean fixoBean = (session.getAttribute(CedentePropostasEstrategia.MANTER_FIXO_BEAN)==null
 	                                      ? new UnidadePVConteudoListaBean()
 	                                      : (UnidadePVConteudoListaBean)session.getAttribute(CedentePropostasEstrategia.MANTER_FIXO_BEAN));
%>
...
<html>
  ...
  <p:Document>
   	<s:FormStrategy name="frmMain" action="SigcbControle" estrategia="consulta.CedentePropostasFiltro" fluxo="normal">   	          				
   		<s:Menu/>
   		<s:Titulo name="Cedentes Propostas (SR) >> Listar"/><!-- AL 18/12/06 - Alterado de EN p/ SR / Capuano -->
		                  ...
		                  <td colspan="4">&nbsp;</td>
										...
										<tr>
											<td colspan="4" align="center">
											  <% String pageName = CedentePropostasEstrategia.PAGE_MANTER_LISTAR_UNIDEN;%>
