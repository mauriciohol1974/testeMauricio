...
<%
	...
	String tpConsulta = (String) session.getAttribute("tpConsulta");
%>
...
<p:Document>
	<s:FormStrategy name="frmMain" action="SigcbControle" 
		estrategia="<%=DebitoTarifaEstrategia.STRATEGY_CONSULTAR_DETALHE%>" fluxo="normal">
		<s:Menu/>
		<s:Titulo name="<%=DebitoTarifaEstrategia.PAGE_TITLE_LISTA_DETALHE%>"/>    
  	...
  	<input type="hidden" name="codigoCedente" value="<%=lancamentoTarifaBean.getCodigoCedente()%>">
		...
		<input type="hidden" name="situacao" value="<%=lancamentoTarifaBean.getSituacao()%>">
    ...
    <table width="777" BORDER="0" cellspacing="0" cellpadding="0">
      <tr> 
	    ...
	    function formSubmit_Voltar() {
						document.frmMain.estrategia.value = '<%=DebitoTarifaEstrategia.STRATEGY_MANTER_FILTRO%>';    	
