...
*Projeto CAIXA - SIGCB
*Componente: contab_consultar_opera.jsp - Java Server Pages
...
<s:Visibility visible="<%=pagina1%>">								
		<s:Titulo name="<%=ContabEstrategia.PAGE_TITLE_PV%>"/>    
</s:Visibility>		  	
<s:Visibility visible="<%=pagina2%>">								
		<s:Titulo name="<%=ContabEstrategia.PAGE_TITLE_REC%>"/>    
</s:Visibility>		  	
<s:Visibility visible="<%=pagina3%>">								
		<s:Titulo name="<%=ContabEstrategia.PAGE_TITLE_CAIXA_REC%>"/>    
</s:Visibility>
<s:Visibility visible="<%=pagina4%>">								
		<s:Titulo name="<%=ContabEstrategia.PAGE_TITLE_CAIXA_PV%>"/>    
</s:Visibility>
...
<s:Visibility visible="<%=!pagina3%>">	
								    ...
								    <td nowrap width="15%" align="right">Saldo Anterior</td>
								    <td nowrap width="15%" align="right">Liquidações</td>
								    <td nowrap width="15%" align="right">Repasse</td>
								    <td nowrap width="15%" align="right">Estorno</td>
								    <td nowrap width="15%" align="right">Saldo Atual</td>
								  </tr>
							<%
...
<s:Visibility visible="<%=!pagina3%>">	
								    ...
								    <td nowrap width="15%" align="right"><%=occ.getSaldoAnterior()%></td>
								    <td nowrap width="15%" align="right"><%=occ.getLiquidacao()%></td>
								    <td nowrap width="15%" align="right"><%=occ.getRepasse()%></td>
								    <td nowrap width="15%" align="right"><%=occ.getEstorno()%></td>
								    <td nowrap width="15%" align="right"><%=occ.getSaldoAtual()%></td>
								  </tr>
						<%  } %>			
									<tr <%=(lista.size())%2 == 0 ? "class='line1'" : "class='line0'" %>>
								    <td nowrap width="2%" align="center">&nbsp;</td>
								    <td nowrap class="textoDestaqueValor" width="10%" align="right">Total</td>
								    <td nowrap class="textoDestaqueValor" width="15%" align="right"><%=contabilBean.getTotalSaldoAnterior()%></td>
								    <td nowrap class="textoDestaqueValor" width="15%" align="right"><%=contabilBean.getTotalLiquidacao()%></td>
								    <td nowrap class="textoDestaqueValor" width="15%" align="right"><%=contabilBean.getTotalRepasse()%></td>
								    <td nowrap class="textoDestaqueValor" width="15%" align="right"><%=contabilBean.getTotalEstorno()%></td>
								    <td nowrap class="textoDestaqueValor" width="15%" align="right"><%=contabilBean.getTotalSaldoAtual()%></td>
								  </tr>
									...
									<tr>
										<td colspan="7" align="center">
											<s:ButtonPaginar 
											  		...
											  		pageName="<%=ContabEstrategia.PAGE_CONSULTAR%>"/>
										</td>
									</tr>
 	                <tr> 
	                  <td colspan="7">&nbsp;</td>
