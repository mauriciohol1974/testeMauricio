...
*Projeto CAIXA - SIGCB
*Componente: gerenc_consultar_qttitINCLIQ.jsp - Java Server Pages
								...
								<table width="100%" border="0" cellspacing="3" cellpadding="0" align="center" valign="middle">
								  <tr class="headerLista">
								    ...
								    <td nowrap width="15%" align="right">Quantidade</td>
 								    ...
 								    <td nowrap width="20%" align="right">Valor Título</td>
 								    <td nowrap width="15%" align="right">% Pago</td>
								  </tr>
							<%								
							...
							for ( int i = 0; i < lista.size(); i++ ) {	
								occ = (GerencTituloBean) lista.get(i);%>
								    ...
								    <td nowrap class="textoValor" width="15%" align="right"><%=Formatador.formataInteiroPadraoBrasileiro(occ.getQtd() == null ? new Long(0) : occ.getQtd())%></td>
 								    ...
 								    <td nowrap class="textoValor" width="20%" align="right"><%=occ.getTarifa()%></td>
 								    <td nowrap class="textoValor" width="15%" align="right"><%=occ.getPercentualTarifa()%></td>
								  </tr>
           	<%}%>								  
								</table>
							</td>
