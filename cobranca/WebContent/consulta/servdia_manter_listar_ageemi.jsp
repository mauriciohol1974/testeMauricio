...
<s:Header/>
  <p:Document>  	
   	<s:FormStrategy name="frmMain" action="SigcbControle" estrategia="<%=ServDiaEstrategia.STRATEGY_AGE_EMI%>" fluxo="normal">   	          				
 		<s:Menu/>   		
		...
		<!--------------------dados cabeçalho excluiso da página---------------------------->
						...
						<tr>
							<td colspan="4">
								<table width="100%" border="0" cellspacing="3" cellpadding="0" align="center" valign="middle">
								  <tr class="headerLista">
								    ...
								    <td nowrap width="20%" align="left" nowrap>&nbsp;&nbsp;Usuário</td>								    
								  </tr>
							<%
							...
							%>
								  <tr <%= ( ((i+1)%2) == 0 ) ? "class='line0'" : "class='line1'" %>>
								    <td width="1%" align="center"><input type="radio" name="rdo" onclick="javascript: clickRadio('<%=occ.getCodigoBancoSacados()%>','<%=occ.getNomeBancoSacados()%>')"></td>
								    <td nowrap width="15%" align="right"><%=occ.getCodigoBancoSacados()%>&nbsp;&nbsp;</td>
 								    <td nowrap width="60%" align="left">&nbsp;&nbsp;<%=occ.getNomeBancoSacados()%></td>
 								    <td nowrap width="60%" align="left">&nbsp;&nbsp;<%=occ.getCodigoUsuario()%></td>
								  </tr>
							<%  } %>
					        <tr> 
         					 <td colspan="9">&nbsp;</td>
									...
									<tr>
							  		...
							  		<s:ButtonPaginar 
							  				...
							  				pageName="<%=ServDiaEstrategia.PAGE_AGE_EMI%>"/>
										</td>
									</tr>
								</table>
							</td>
