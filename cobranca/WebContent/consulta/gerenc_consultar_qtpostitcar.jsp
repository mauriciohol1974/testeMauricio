...
*Projeto CAIXA - SIGCB
*Componente: gerenc_consultar_qtpostitcar.jsp - Java Server Pages
						...
						<tr>
								...
								<table width="100%" border="0" cellspacing="3" cellpadding="0" align="center" valign="middle">
								  <tr class="headerLista">
								    <td nowrap width="1%" align="center">&nbsp;</td>
 								    <td nowrap width="20%" align="left">Titulos</td>
							...
							for ( int i = 0; i < lista.size(); i++ ) {	
								occ = (GerencTituloBean) lista.get(i);%>
								    ...
								    <td nowrap class="textoValor" width="15%" align="right"><%=occ.getQtdSemReg()%></td>
