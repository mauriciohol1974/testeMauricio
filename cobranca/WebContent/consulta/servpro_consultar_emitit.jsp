...
*Projeto CAIXA - SIGCB
*Componente: servpro_consultar_emitit.jsp - Java Server Pages
...
<%
	...
	ConGerServicosSolicitadosBean dataBean 	= (session.getAttribute(ServProEstrategia.BEAN_TIT_EMI_DET)==null? new ConGerServicosSolicitadosBean()
																		: (ConGerServicosSolicitadosBean)session.getAttribute(ServProEstrategia.BEAN_TIT_EMI_DET));
%>
