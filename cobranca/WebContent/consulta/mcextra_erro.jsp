...
*Projeto CAIXA - SIGCB
*Componente: mcextra_erro.jsp - Java Server Pages
*Autor: Valdir Castaldelli Junior - vcastaldelli@sao.politec.com.br
*Ultima Atualização: 14/10/2004
************************************************/
%>
...
<%
	...
	if (session.getAttribute(MCExtraEstrategia.BEAN_MSG)==null) {
		msgBean = new MsgSucessoErroBean();
		msgBean.setStrategyErrorReturn(msgBean.getStrategyErrorReturn());
	} else {
		msgBean = (MsgSucessoErroBean) session.getAttribute(MCExtraEstrategia.BEAN_MSG);
	}
	...
	ConGerMovimentoCedenteBean filtroBean = (ConGerMovimentoCedenteBean)session.getAttribute(MCExtraEstrategia.BEAN_FILTRO);
	
	CedenteCabecaBean cedCabBean = 	(session.getAttribute(MCExtraEstrategia.BEAN_CABECALHO)==null? new CedenteCabecaBean()
...
<p:Document>
    ...
    <input type="hidden" name="dataEmissao" value="<%= filtroBean.getDataEmissaoFormatada()%>"/>
        ...
        <td valign="top" width="95%" height="14" align="left"> 
          <table width="95%" border="0" cellspacing="0" cellpadding="0" height=53 valign="middle" align="center">						
            ...
            <tr>
	            ...
	            <td class="textoValor" width="26%"><%=cedCabBean.getCodigoClienteCOCLI().toString()%></td> 
	            <td class="textoTitulo" width="17%">Data: </td>
              <td class="textoValor" width="26%"><%=filtroBean.getDataEmissaoFormatada()%></td>
	          </tr>
            <tr>
              <td colspan="4">&nbsp;</td>
            </tr>        
