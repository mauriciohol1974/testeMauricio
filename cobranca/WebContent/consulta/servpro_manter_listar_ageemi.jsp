...
<s:Header/>
  <p:Document>  	
   	<s:FormStrategy name="frmMain" action="SigcbControle" estrategia="consulta.ServProAgeEmiConsultarDetIniciar" fluxo="normal">   	          				
 		<s:Menu/>   		
 		<s:Titulo name="<%=ServProEstrategia.PAGE_TITLE_LISTAR_CEDENTE%>"/>
							...
							<td colspan="4">
								<table width="100%" border="0" cellspacing="3" cellpadding="0" align="center" valign="middle">
								  <tr class="headerLista">
								    ...
								    <td nowrap width="15%" align="right" nowrap>Usuário</td>
								  </tr>
							<%
         					 ...
         					 <td colspan="9">&nbsp;</td>
									...
									<tr>
							  		...
							  		<s:ButtonPaginar 
							  				...
							  				pageName="<%=ServProEstrategia.PAGE_AGE_EMI%>"/>
										</td>
									</tr>
								</table>
							</td>
