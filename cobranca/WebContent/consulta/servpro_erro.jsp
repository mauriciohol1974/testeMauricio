...
*Projeto CAIXA - SIGCB
*Componente: servpro_erro.jsp - Java Server Pages
...
<%
	...
	if (session.getAttribute(ServProEstrategia.BEAN_MSG)==null) {
		msgBean = new MsgSucessoErroBean();
		msgBean.setStrategyErrorReturn(msgBean.getStrategyErrorReturn());
	} else {
		msgBean = (MsgSucessoErroBean) session.getAttribute(ServProEstrategia.BEAN_MSG);
	}
	...
	ConGerServicosSolicitadosBean cabeEXBean =(ConGerServicosSolicitadosBean)session.getAttribute(ServProEstrategia.BEAN_FILTRO);
