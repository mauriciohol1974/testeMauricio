...
*Projeto CAIXA - SIGCB
*Componente: salcob_erro.jsp - Java Server Pages
...
<%
	...
	if (session.getAttribute(SaldoCobrancaEstrategia.MSG_BEAN)==null) {
		msgBean = new MsgSucessoErroBean();
		msgBean.setStrategyErrorReturn(msgBean.getStrategyErrorReturn());
	} else {
		msgBean = (MsgSucessoErroBean) session.getAttribute(SaldoCobrancaEstrategia.MSG_BEAN);
	}
