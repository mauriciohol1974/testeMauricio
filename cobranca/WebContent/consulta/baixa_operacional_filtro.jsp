...
<%
	BaixaOperacionalBean baixaBean = (session.getAttribute(BaixaOperacionalEstrategia.FILTRO_BEAN)==null?new BaixaOperacionalBean():(BaixaOperacionalBean)session.getAttribute(BaixaOperacionalEstrategia.FILTRO_BEAN));	
...
<html>
	...
	<s:FormStrategy name="frmMain" action="SigcbControle" 
				estrategia='<%=BaixaOperacionalEstrategia.STRATEGY_MANTER_FILTRO%>' fluxo="normal">
	<s:Menu/>
		<s:Titulo name='<%=BaixaOperacionalEstrategia.PAGE_TITLE_FILTRO%>'/>
