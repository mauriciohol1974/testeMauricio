...
*Projeto CAIXA - SIGCB
*Componente: servpro_consultar_extmovtit.jsp - Java Server Pages
          ...
          <table width="95%" border="0" cellspacing="1" cellpadding="1" height=53 valign="middle" align="center">
	        ...
	        <tr>
	            <td class="textoTitulo" width="17%" valign="top">Data Solicitação:</td>
              	<td class="textoValor"  width="26%" valign="top"><%=cabeEXBean.getDataSolicitacaoFormatada()%></td>
	        </tr>
									...
									<tr>
										<td colspan="5" align="center">
							  			<s:ButtonPaginar 
							  				...
							  				pageName="<%=ServProEstrategia.PAGE_REI_TIT_BAI%>"/>
										</td>
									</tr>
								</table>
							</td>
