...
<p:Document>
	<s:FormStrategy name="frmMain" action="SigcbControle"
		estrategia="consulta.DdaTitIncluidoConsultar" fluxo="normal">
		<s:Menu />
		<s:Titulo name="DDA >> Consultar Títulos Incluidos" />
		...
		<table width="777" BORDER="0" cellspacing="0" cellpadding="0">
			<tr>
				...
				<table width="95%" border="0" cellspacing="1" cellpadding="0"
					...
					<tr valign="top">
						<td colspan="5" class="textoTitulo">Titulos Incluídos:
						<hr>
						</td>
					</tr>
                    ...
                    %>
							...
							<tr>
								<td colspan="6" align="center"><%String pageName = DdaTitIncluidoEstrategia.PAGE_LIQ_LISTA_CED;%>
								<!-- s:ButtonPaginar 
											  		pageNumber="<%=paginacao.getPageNumber()%>" 
											  		numberOfPages="<%=paginacao.getPageCount()%>" 
											  		pageName="<%=pageName%>"/--><s:paginacao
									estrategia="consulta.DdaTitIncluidoManterFiltro" /></td>
							</tr>
							<tr>
								<td colspan="5">&nbsp;</td>
							</tr>
	    ...
	    //function clickRadio(nossoNumero , sequencialDia) {
