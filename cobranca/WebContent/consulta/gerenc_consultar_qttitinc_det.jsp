...
*Projeto CAIXA - SIGCB
*Componente: gerenc_consultar_qttitinc_det.jsp - Java Server Pages
...
<%
	...
	gerencBean.setTipoTitulo(filtroBean.getTipoTitulo());
%>
								...
								<table width="100%" border="0" cellspacing="3" cellpadding="0" align="center" valign="middle">
								  <tr class="headerLista">
								    <td nowrap width="1%" align="center">&nbsp;</td>
 								    <td nowrap width="20%" align="left"><%=gerencBean.getTipoTituloTexto2()%></td>
