...
*Projeto CAIXA - SIGCB
*Componente: TitLiqD_erro.jsp - Java Server Pages
...
<%
	...
	if (session.getAttribute(TitLiqDManterEstrategia.MSG_BEAN)==null) {
		msgBean = new MsgSucessoErroBean();
		msgBean.setStrategyErrorReturn(msgBean.getStrategyErrorReturn());
	} else {
		msgBean = (MsgSucessoErroBean) session.getAttribute(TitLiqDManterEstrategia.MSG_BEAN);
	}
	...
	ConGerTitulosLiquidadosDiaBean titliqBean = (session.getAttribute(TitLiqDManterEstrategia.FILTRO_BEAN)==null? new ConGerTitulosLiquidadosDiaBean()
																				:(ConGerTitulosLiquidadosDiaBean)session.getAttribute(TitLiqDManterEstrategia.FILTRO_BEAN));
	
	CedenteCabecaBean cedCabBean = 	(session.getAttribute(TitLiqDManterEstrategia.CABECALHO_BEAN)==null? new CedenteCabecaBean()
