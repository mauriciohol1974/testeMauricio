...
<s:Header/>
  <p:Document>  	
   	<s:FormStrategy name="frmMain" action="SigcbControle" estrategia="consulta.DdaTitAlteradoRejManterFiltro" fluxo="normal">   	          				
 		<s:Menu/>   		
 		<s:Titulo name="DDA >> Consultar Títulos Alterados Rejeitados >> Listar"/>
 	                ...
 	                <tr> 
	                  <td colspan="6">&nbsp;</td>
									...
									<tr>
										...
										<% String pageName = DdaTitIncluidoEstrategia.PAGE_DDA_LISTA_PV_A_REJ;%>
										  <s:ButtonPaginar 
