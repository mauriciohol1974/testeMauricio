...
*Projeto CAIXA - SIGCB
*Componente: TitLiq_erro.jsp - Java Server Pages
...
<%
	...
	if (session.getAttribute(TitLiqManterEstrategia.MSG_BEAN)==null) {
		msgBean = new MsgSucessoErroBean();
		msgBean.setStrategyErrorReturn(msgBean.getStrategyErrorReturn());
	} else {
		msgBean = (MsgSucessoErroBean) session.getAttribute(TitLiqManterEstrategia.MSG_BEAN);
	}
	...
	ConGerTitulosLiquidadosDiaBean titliqBean = (session.getAttribute(TitLiqManterEstrategia.FILTRO_BEAN)==null? new ConGerTitulosLiquidadosDiaBean()
