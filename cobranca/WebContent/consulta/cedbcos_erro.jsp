...
*Projeto CAIXA - SIGCB
*Componente: cedbcos_error.jsp - Java Server Pages
...
<%
	...
	if (session.getAttribute(CedBcoSEstrategia.MSG_BEAN)==null) {
		msgBean = new MsgSucessoErroBean();
		msgBean.setStrategyErrorReturn(msgBean.getStrategyErrorReturn());
	} else {
		msgBean = (MsgSucessoErroBean) session.getAttribute(CedBcoSEstrategia.MSG_BEAN);
	}
        ...
        <td valign="top" width="95%" height="14" align="left"> 
          <table width="95%" border="0" cellspacing="0" cellpadding="0" height=53 valign="middle" align="center">
            ...
            <tr>
  	          ...
  	          <td class="textoValor" width="26%"><%=cedBcoBean.getCodigoCedente().equals(new Long(0))?"":cedBcoBean.getCodigoCedenteFormatado()%></td>
