...
*Projeto CAIXA - SIGCB
*Componente: servdia_consultar_ageemi.jsp - Java Server Pages
...
<%
	...
	ConGerServicosSolicitadosBean dataBean 	= (session.getAttribute(ServDiaEstrategia.BEAN_AGE_EMI_DET)==null? new ConGerServicosSolicitadosBean()
																		: (ConGerServicosSolicitadosBean)session.getAttribute(ServDiaEstrategia.BEAN_AGE_EMI_DET));
%>
      ...
      <tr> 
        <td valign="top" width="95%" height="14" align="left"> 
          <table width="95%" border="0" cellspacing="0" cellpadding="0" height=53 valign="middle" align="center">
            ...
            <tr>
              <td class="textoTitulo" width="17%">Data de Solicitação: </td>
