...
*Projeto CAIXA - SIGCB
*Componente: mctotai_erro.jsp - Java Server Pages
...
<%
	...
	if (session.getAttribute(MCTotaiEstrategia.BEAN_MSG)==null) {
		msgBean = new MsgSucessoErroBean();
		msgBean.setStrategyErrorReturn(msgBean.getStrategyErrorReturn());
	} else {
		msgBean = (MsgSucessoErroBean) session.getAttribute(MCTotaiEstrategia.BEAN_MSG);
	}
	...
	ConGerMovimentoCedenteBean filtroBean = (ConGerMovimentoCedenteBean)session.getAttribute(MCTotaiEstrategia.BEAN_FILTRO);
