...
*Projeto CAIXA - SIGCB
*Componente: contab_erro.jsp - Java Server Pages
*Autor: Eduardo A. Morás emoras@sao.politec.com.br
*Ultima Atualização: 12/11/2004
************************************************/
%>
...
<%
	...
	if (session.getAttribute(ContabEstrategia.MSG_BEAN)==null) {
		msgBean = new MsgSucessoErroBean();
		msgBean.setStrategyErrorReturn(msgBean.getStrategyErrorReturn());
	} else {
		msgBean = (MsgSucessoErroBean) session.getAttribute(ContabEstrategia.MSG_BEAN);
	}
