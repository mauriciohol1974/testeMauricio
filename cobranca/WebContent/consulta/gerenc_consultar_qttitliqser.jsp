...
*Projeto CAIXA - SIGCB
*Componente: gerenc_consultar_qttitliqser.jsp - Java Server Pages
            ...
            <tr valign="top"> 
              <td colspan="4" class="textoTitulo">Consulta:
						...
						<tr>
							<td colspan="4">
								<table width="100%" border="0" cellspacing="3" cellpadding="0" align="center" valign="middle">
								  ...
								  <tr class="headerLista">
								    ...
								    <td nowrap width="15%" align="right">Qtde.</td>
							...
							for ( int i = 0; i < lista.size(); i++ ) {	
								occ = (GerencTituloBean) lista.get(i);%>
								    ...
								    <td nowrap class="textoValor" width="15%" align="right"><%=Formatador.formataInteiroPadraoBrasileiro(occ.getQtd() == null ? new Long(0) : occ.getQtd())%></td>
 								    <td nowrap class="textoValor" width="15%" align="right"><%=occ.getValor()%></td>
								    <td nowrap class="textoValor" width="15%" align="right"><%=Formatador.formataInteiroPadraoBrasileiro(occ.getQtdSemReg()== null ? new Long(0) : occ.getQtdSemReg())%></td>
 								    <td nowrap class="textoValor" width="15%" align="right"><%=occ.getValorSemReg()%></td>
								  </tr>
           	...
           	<%}%>
								    ...
								    <td nowrap class="textoDestaqueValor" width="15%" align="right"><%=Formatador.formataInteiroPadraoBrasileiro(gerencBean.getTotalQtd()== null ? new Long(0) : gerencBean.getTotalQtd())%></td>
 								    <td nowrap class="textoDestaqueValor" width="15%" align="right"><%=gerencBean.getTotalValor()%></td>
								    <td nowrap class="textoDestaqueValor" width="15%" align="right"><%=Formatador.formataInteiroPadraoBrasileiro(gerencBean.getTotalQtdSemReg()== null ? new Long(0) : gerencBean.getTotalQtdSemReg())%></td>
 								    <td nowrap class="textoDestaqueValor" width="15%" align="right"><%=gerencBean.getTotalValorSemReg()%></td>
								  </tr>
