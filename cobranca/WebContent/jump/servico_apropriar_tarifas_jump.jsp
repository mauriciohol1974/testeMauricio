...
<p:Document>
	<s:FormStrategy name="frmMain" action="SigcbControle" estrategia="servico.SimuladorNegocialApropriarFinalizar" fluxo="normal">
		<input type="hidden" name="cpfCnpj">
		<input type="hidden" name="icPessoa">
		<input type="hidden" name="nuSimulacao">
		<input type="hidden" name="codCedente">
		...
		<script>
			...
			function formSubmit() {
				...
				document.frmMain.codCedente.value=opener.frmMain.codCedente.value;
