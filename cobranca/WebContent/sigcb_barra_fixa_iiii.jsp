...
<!-- saved from url=(0036)http://www.caixa/barracorp/barra.htm -->


<HTML><HEAD><META content="IE=5.0000" http-equiv="X-UA-Compatible">
<TITLE>Untitled Document</TITLE>
<LINK rel=stylesheet href="/arquivos/estilo1.css">
...
function troca_img() {
	...
	if (fpAnimswapImgFP1.src="arquivos/BUSCA4.gif") {
		fpAnimswapImgFP1.src="arquivos/BUSCA5.gif";}
	else {
		fpAnimswapImgFP1.src="arquivos/BUSCA4.gif";}
}
...
//-->
      ...
      background=arquivos/barra_branco_nova.gif border=0>
        <TBODY>
        <TR>
          <TD height=41 vAlign=middle width=256>&nbsp; <A 
            href="http://www.caixa/" target=_top><IMG border=0 
            alt="Página Principal" 
            src="arquivos/logo_nova.gif" width=105 
            height=27> </A></TD></TR></TBODY></TABLE></TD><!--td width="781"-->
    <TD width=670>
      <SCRIPT language=javascript>
<!--
//if (screen.height > 700) {
//	document.write('<table cellspacing="0" width="795" height="43" background="arquivos/barra_azul_02.jpg">')
//} else {
	document.write('<table cellspacing="0" width="670" height="43" background="arquivos/barra_azul_nova.jpg" border = "0">')
//}

//-->
</SCRIPT>
<!--table cellspacing="0" width="781" height="43" background="arquivos/barra_azul_02.jpg"-->
  <TR>
    ...
    <TD height=18 vAlign=middle width=3 align=center>
      ...
      src="arquivos/divisoria.gif" width=4 
    height=17></DIV></TD>
    ...
    <TD height=18 vAlign=middle width=48 align=center>
      ...
      target=_top><SMALL>Portfólio</SMALL></A></FONT></DIV></TD>
    ...
    <TD height=18 vAlign=top width=109 align=center>
      ...
      -->
    <TD height=18 vAlign=middle width=45 align=center><!--<p align="left"><a id="fpbtnbusca" onmouseover="window.fpbtnbusca.style.cursor='hand';" onclick = "document['fpAnimswapImgFP1'].imgRolln=document['fpAnimswapImgFP1'].src;document['fpAnimswapImgFP1'].src=document['fpAnimswapImgFP1'].lowsrc; busca();"  ><img border="0" src="arquivos/BUSCA4.gif" id="fpAnimswapImgFP1" name="fpAnimswapImgFP1" dynamicanimation="fpAnimswapImgFP1" lowsrc="arquivos/BUSCA5.gif" width="60" height="17"></a></td>-->
      ...
      src="arquivos/BUSCA4.gif" width=60 height=17 
