   							 ...
   							 <td class="textoTitulo" width="13%" style='width:13.72%;padding:.75pt .75pt .75pt .75pt'>
								  ...
								  %>
			                        <select size="1" name="cmbBloqExpresso">
										...
										<option <%=icboleto.equals("N") ? "selected='selected'" : ""%> value="N">NÃO</option>
									</select>
								   <%}else{ %>
                    ...
                    <tr> 
	   						...
	   						<tr style='mso-yfti-irow:1;mso-yfti-lastrow:yes'>
	    						...
	    						<td  class="textoTitulo" width=130 style='width:97.5pt;padding:.75pt .75pt .75pt .75pt'>
					                       ...
					                       <select size="1" name="cmbAutorizacao">
											    ...
											    <option <%=autorizacao.equals("N") ? "selected='selected'" : ""%> value="N">NÃO</option>
					  ...
					  %>
                       <select size="1" name="cmbIcgarantia">
		                   ...
		                   <option <%=icgarantia.equals("N") ? "selected='selected'" : ""%> value="N">NÃO</option>
					  ...
					  %>
                       <select size="1" name="cmbValorBoleto" onchange="liberaValor()">
                       		<option <%=icvalor.equals("N") ? "selected='selected'" : ""%> value="N">NÃO</option>
                    ...
                    <tr>
					  ...
					  %>
                        <select size="1" name="cmbCreditoOnLine">
                       	<option <%=creditoOnline.equals("N") ? "selected='selected'" : ""%> value="N">NÃO</option>
					  ...
					  <td>
							 <%
					  		 ...
					  		 %>
					  		  ...
					  		  <option <%=clienteExternoPar.equals("N") ? "selected='selected'" : ""%> value="N">NÃO</option>
						...
						<td>
							 <%
							  ...
							  <select size="1" name="cmbIcFinalizacao" onchange="liberaUnidade()">
					  		  <option <%=icFinalizacao.equals("N") ? "selected='selected'" : ""%> value="N">NÃO</option>
	    ...
	    function comboBaixa(){
	    	if (document.frmMain.icBaixa.value != document.frmMain.cmbGarantiaAtual.value){
	    		if (document.frmMain.icBaixa.value == "S"){
	    			if (confirm("Os títulos já existentes na base de dados do Cedente também devem ser marcados como Garantia de Crédito?")){
	    			...
	    			if (confirm("Os títulos já existentes na base de dados do Cedente devem ser desmarcados, ou seja, retirar Garantia de Crédito?")){
	    				document.frmMain.icDesmarcado.value = "S";
	    				document.frmMain.cmbDesmarcado.value = "S";
	    			}else{
