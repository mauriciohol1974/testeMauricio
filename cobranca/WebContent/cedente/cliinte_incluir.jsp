...
<%
  ...
  ClienteInternetBean clienteInternetBean2 = (session.getAttribute(CliInteEstrategia.FILTRO_BEAN)==null?new ClienteInternetBean():(ClienteInternetBean)session.getAttribute(CliInteEstrategia.FILTRO_BEAN));
...
<p:Document>
  <s:FormStrategy name="frmMain" action="SigcbControle" 
    estrategia="<%=CliInteEstrategia.STRATEGY_INCLUIR_FINALIZAR%>" fluxo="normal">
    <s:Menu/>
    <s:Titulo name="<%=CliInteEstrategia.PAGE_TITLE_INCLUIR%>"/>

    <input type="hidden" name = "codigoCedente" value="<%=clienteInternetBean2.getCodigoCedente()%>">
    <input type="hidden" name = "cpfUsuario" value="<%=clienteInternetBean2.getCpfUsuario()%>">
        ...
        <td valign="top" width="95%" height="14" align="left"> 
          <table width="95%" border="0" cellspacing="1" cellpadding="0" height=53 valign="middle" align="center">
            ...
            <tr>
	            ...
	            <td class="textoValor" width="26%"><%=Formatador.formatarCpf(clienteInternetBean2.getCpfUsuario()+"")%></td>
	        </tr>
            <tr>
              <td colspan="4">&nbsp;</td>
            </tr>
    ...
    <script>
	  ...
	  function validaTamanhoSenha(senha) {
        ...
        var campoNumero = document.getElementsByName('numero')[0];
        if(campoNumero.getAttribute('value')) {
            if(!validaInputNumerico(campoNumero)){
                msg("072","Número","","",false,"");
                campoNumero.focus();
                return false;
            }
        }   
        
       //alert(document.frmMain.senha.value);
       //alert(document.frmMain.senha1.value);       
