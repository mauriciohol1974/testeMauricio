...
<%
	...
	ClienteInternetBean clienteInternetFiltroBean = (session.getAttribute(CliInteEstrategia.FILTRO_BEAN)==null?new ClienteInternetBean():(ClienteInternetBean)session.getAttribute(CliInteEstrategia.FILTRO_BEAN));
%>
        ...
        <td valign="top" width="95%" height="14" align="left"> 
          <table width="95%" border="0" cellspacing="0" cellpadding="0" height=53 align="center">
            <tr>
              ...
              <td class="textoValor" width="26%"><%=clienteInternetFiltroBean.getTipoPessoaCedente() == null? "" : clienteInternetFiltroBean.getTipoPessoaCedente().longValue()==1? "FÍSICA": "JURIDICA"%></td>
              <td class="textoTitulo" width="17%">CPF/CNPJ:</td>
              <td class="textoValor" width="26%"><%=clienteInternetFiltroBean.getCpfCnpjCedente() == null? "" : Formatador.formatarCpfCnpj(clienteInternetFiltroBean.getCpfCnpjCedente().toString())%></td>
            </tr>
            <tr>
              <td class="textoTitulo" width="17%">CPF Usuário:</td>
              <td class="textoValor" colspan="3"><%=clienteInternetFiltroBean.getCpfUsuario() == null? "" : Formatador.formatarCpf(clienteInternetFiltroBean.getCpfUsuario().toString())%></td> 
            </tr>
