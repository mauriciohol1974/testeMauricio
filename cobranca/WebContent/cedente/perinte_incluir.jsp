...
*Projeto CAIXA - SIGCB
*Componente: perinte_incluir.jsp - Java Server Pages
*Autor: JE
...
<p:Document>
	<s:FormStrategy name="frmMain" action="SigcbControle" 
		estrategia="<%=PerInteEstrategia.STRATEGY_INCLUIR_FINALIZAR%>" fluxo="normal">
		<s:Menu/>
		<s:Titulo name="<%=PerInteEstrategia.PAGE_TITLE_INCLUIR%>"/>
      ...
      <tr> 
        <td valign="top" width="95%" height="14" align="left"> 
          <table width="95%" border="0" cellspacing="1" cellpadding="0" height=53 align="center">
            ...
            <tr valign="top"> 
              <td colspan="4" class="textoTitulo">Incluir Perfil Internet
                <hr>
              </td>
            </tr>
    ...
    <script>
	    ...
	    function formSubmit() {
	        if (validaSubmit()) {
		    	if (confirm(conf("100", "Perfil Internet"))) {
	    ...
	    function formSubmit_Voltar() {
    		if (confirm(conf("103"))) {
	           document.frmMain.estrategia.value = "<%=PerInteEstrategia.STRATEGY_INCLUIR_INICIAR%>";
