...
%>
                                          ...
                                          <td colspan="12">&nbsp;</td>
                                                ...
                                                <tr>
                                                  <td align="right" colspan="12">
                                                    <p align="center">
                                                                        <s:Button name="buttonAtualizarGuia" value="Recalcular" action="javascript:atualizarGuia();" userGroup="<%=usuarioLDAPBean.getNomeGrupo()%>" internalAction="cedente.cadastro.manter.alterar"/>
                                                                    </p>
                                                                </td>
                                        </tr>
                                                            <tr>
                    ...
                    <tr>
                      <td align="right" colspan="4">
                        <p align="center">
                          <s:Button name="Confirmar" action="javascript:formSubmit_Contas();" userGroup="<%=usuarioLDAPBean.getNomeGrupo()%>" internalAction="cedente.cadastro.manter.alterar"/>
...
%>
        ...
        function showContasRateio() {
            if (document.frmMain.selectNumeroContas.value != <%= numeroContas %>) {
                    document.frmMain.action="<%=Paths.getRootForDynamicContent()%>/cedente/cedente_alterar_guiacontas.jsp";
                //habilitaCampos();
            ...
            function formSubmit_Contas() {
                ...
                if (confirma) {
                        document.frmMain.estrategia.value="cedente.CedenteAlterarGuiaContasFinalizar";
                        habilitaCampos();
                        document.frmMain.submit();
                    }
                }
