...
<%
  ...
  if (session.getAttribute(CliInteEstrategia.FILTRO_BEAN)!=null){
		ClienteInternetBean clienteInternetFiltroBean = (ClienteInternetBean)session.getAttribute(CliInteEstrategia.FILTRO_BEAN);
		if (!clienteInternetFiltroBean.getCodigoCedente().equals(new Long(0)))
			cedCabBean.setCodigoCedente(clienteInternetFiltroBean.getCodigoCedente());
		if (!clienteInternetFiltroBean.getCpfCnpjCedente().equals(new Long(0)))
		cedCabBean.setCpfCnpj(clienteInternetFiltroBean.getCpfCnpjCedente());
  }
%>
