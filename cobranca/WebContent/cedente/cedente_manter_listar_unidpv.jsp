...
<html>
  ...
  <p:Document>
   	<s:FormStrategy name="frmMain" action="SigcbControle" estrategia="cedente.CedenteManterFiltro" fluxo="normal">   	          				
   		<s:Menu/>
   		<s:Titulo name="Manter Cedente (PV) >> Listar"/>
   		...
   		<input type="hidden" name="radioTipoConsulta">
			<input type="hidden" name="radioTipoConsultaAnterior" value="<%=CedenteEstrategia.OPCAO_BUSCA_UNIDADE%>">
			<input type="hidden" name="codigoUnidade" value="<%= fixoBean.getCodigoUnidadePV() %>">
...
%>									  
		                  ...
		                  <td colspan="5">&nbsp;</td>
										...
										<tr>
											<td colspan="5" align="center">
											  <% String pageName = CedenteEstrategia.PAGE_MANTER_LISTAR_UNIDPV;%>
	    ...
	    <script language="javascript">
	        ...
	        if (validaSubmit()) {
	        	document.frmMain.situacao.disabled = true; // causa conflito com situacao de outro bean do consultar
