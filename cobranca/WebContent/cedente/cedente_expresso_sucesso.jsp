...
<%
CedenteExpressoBean conclusaoBean = (request.getAttribute(CedenteEstrategia.INCLUIR_EXPRESSO_BEAN_CONFIRMA)==null
 	                                     ? new CedenteExpressoBean()
 	                                     : (CedenteExpressoBean)request.getAttribute(CedenteEstrategia.INCLUIR_EXPRESSO_BEAN_CONFIRMA));
