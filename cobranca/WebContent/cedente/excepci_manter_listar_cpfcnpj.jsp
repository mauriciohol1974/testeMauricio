...
*Projeto CAIXA - SIGCB
*Componente: excepci_manter_listar_cpfcnpj.jsp - Java Server Pages
...
<html>
	...
	<p:Document>
		...
		<s:Menu/>
		<s:Titulo name="Excepcionação de Pendência de Alçada (CPF/CNPJ) >> Listar"/>	  
        ...
        <td valign="top" width="95%" height="14" align="left"> 
          <table width="95%" border="0" cellspacing="1" cellpadding="0" height=53 valign="middle" align="center">
            ...
            <tr>
              ...
              <td class="textoValor" width="26%"><%=filtroBean.getDescTipoPessoa()%></td>
              <td class="textoTitulo" width="17%">CPF/CNPJ: </td>
              <td class="textoValor" width="26%"><%=filtroBean.getCpfCnpjFormatado()%></td>
            </tr>
            <tr> 
              <td colspan="4">&nbsp;</td>
            </tr>
							...
							<td colspan="4">
								<table width="100%" border="0" cellspacing="3" cellpadding="0" align="center" valign="middle">
								  <tr class="headerLista">
								    ...
								    <td width="88%" align="left">Nome Cedente</td>
 	                ...
 	                <tr> 
	                  <td colspan="4">&nbsp;</td>
									...
									<tr>
										...
										<% String pageName = ExcepciManterEstrategia.PAGE_LISTAR_CPFCNPJ;%>
										  <s:ButtonPaginar 
