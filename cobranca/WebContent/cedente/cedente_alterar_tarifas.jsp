...
<%
	...
	String nsuTransacao = "";
	if (tarifasBean.getNsuTransacao() != null) {
		nsuTransacao = tarifasBean.getNsuTransacao();
	} else if (request.getParameter("nsuTransacao") != null) {
		nsuTransacao = request.getParameter("nsuTransacao");
	}
%>
                  ...
                  <%} %>
									<tr>
										<td colspan="6" align="center">
											<% String pageName = CedenteEstrategia.PAGE_ALTERAR_TARIFAS_INFORME;%>
	    ...
	    function formSubmit() {
	        if (validaInserir()) {
	        	var confirma = confirm(conf('114'));
		    		...
		    		if (confirma) {
				    	document.frmMain.estrategia.value="cedente.CedenteAlterarTarifasFinalizar";
