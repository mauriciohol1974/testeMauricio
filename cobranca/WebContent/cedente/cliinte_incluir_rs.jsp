...
*Projeto CAIXA - SIGCB
*Componente: cliinte_incluir_rs.jsp - Java Server Pages
*Autor: Glauber M. Gallego
*Ultima Atualização: 16/12/2004 16:08
************************************************/
%>
...
<p:Document>
  <s:FormStrategy name="frmMain" action="SigcbControle" 
    estrategia="<%=CliInteEstrategia.STRATEGY_INCLUIR_RS_FINALIZAR%>" fluxo="normal">
    <s:Menu/>
    ...
    <script>
      ...
      return true;
		...
		function formSubmit_Voltar() {
	    	if (confirm(conf("103"))) {
       		document.frmMain.estrategia.value = "<%=CliInteEstrategia.STRATEGY_INCLUIR_FILTRO%>";
