                    ...
                    <tr>
                    	<td colspan="4">
		                  <table class="box" width="50%" border="0" cellspacing="2" cellpadding="0" height=14 valign="middle" align="center">
								...
								<tr>
									<td class="textoTitulo" width="17%">Autorizador</td>
									<td class="textoValor" width="26%"></td>
								</tr>
								...
								<tr>
									<td class="textoTitulo" width="17%">Matricula:</td>
									<td class="textoValor" width="26%"></td>
								</tr>
								
								<tr>
									<td class="textoTitulo" width="17%">Unidade vinculada:</td>
									<td class="textoValor" width="26%"></td>
								</tr>
          					...
          					<table>
          						   ...
          						   <tr class="headerLista"> 
											...
											for (int i=0;i<simulacaoBean.getTarifaSimulacao().size();i++){ 
												 ...
												 tarifa = (TarifaSimulaBean) simulacaoBean.getTarifaSimulacao().get(i);
											%>
											
											<tr>
												<td class="textoTitulo" width="40%"><%= tarifa.getCoTarifa() %></td>
												<td class="textoTitulo" width="20%"><%= tarifa.getVrTarifa() %></td>
          						   ...
          						   <tr class="headerLista"> 
	          						   	<tr>
											<td class="textoTitulo" width="40%"></td>
											<td class="textoTitulo" width="20%">VALOR PADRÃO</td>
											<td class="textoTitulo" width="20%">VALOR NEGOCIADO</td>
										</tr>
											<%
											...
											for (int i=0;i<simulacaoBean.getCanalSimulacao().size();i++){ 
												 CanalSimulacaoBean canal = new CanalSimulacaoBean();
												 canal = (CanalSimulacaoBean) simulacaoBean.getCanalSimulacao().get(i);
											%>
											
											<tr>
												<td class="textoTitulo" width="40%"><%= canal.getCoCanal() %></td>
												<td class="textoTitulo" width="20%"><%= canal.getPrazo() %></td>
												<td class="textoTitulo" width="20%"></td>
												<td class="textoTitulo" width="20%"></td>
											</tr>
											<%} %>
