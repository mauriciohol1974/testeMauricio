            ...
            <tr>
              <td colspan="4">
                  ...
                  <table width="95%" border="0" cellspacing="0" cellpadding="0" height=14 valign="middle" align="center">
                    ...
                    <tr> 
                      <td colspan="4" class="textoDestaqueTitulo">Guia: Conclusão do Cadastramento</td>
                    </tr>
                    <tr> 
                      <td colspan="4">&nbsp;</td>
                    </tr>
                    <tr>
                      <td class="textoTitulo" width="17%">SR: </td><!-- AL 18/12/06 - Alterado de EN p/ SR / Capuano -->
                    ...
                    <tr>
                      <td class="textoTitulo" width="17%">Código Cedente SINCO: </td>
                      <td class="textoValor" width="26%">				              	
                      	<p:InputNumerico CLASS="inputtext" 
				              	 name="codigoCedente" size="8" maxlength="7"
                    ...
                    <tr>
                      <td align="right" colspan="4">
                        <p align="center"> 
                          <s:Button name="Confirmar" value="Confirmar" action="javascript:formSubmit_Conclusao();" />
